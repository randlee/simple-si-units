...
```json
{
  ...
  "phase_id": "phase-A",
  "integration_branch": "integration/phase-A",
  "integration_worktree_path": "/abs/integration-phase-A",
  "finding_id": "FTQ-001",
  ...
  "triage_root": "/abs/integration-phase-A/.triage",
  "references": [
    "PR #194",
...
<urn:atm:triage:occurrence/FTQ-001/R17/1>
  a triage:Occurrence ;
  triage:file "crates/units-x/src/tests.rs" ;
  triage:line 28 ;
...
```json
{
  ...
  "data": {
    ...
    "dispatch_ready": true,
    "ttl_path": "/abs/integration-phase-A/.triage/phase-A/findings/FTQ-001.ttl",
    "dispatch_blocked_pending_triage_commit": true,
    "occurrences": [
      {
        "branch": "R.17",
        "head_sha": "9421e9f",
        "file": "crates/units-x/src/tests.rs",
        "line": 28,
