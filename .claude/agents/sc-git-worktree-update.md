...
```json
{
  ...
  "error": {
    ...
    "worktree_path": "../{{REPO_NAME}}-worktrees/main",
    "recoverable": true,
    "suggested_action": "Resolve conflicts in worktree at '../{{REPO_NAME}}-worktrees/main', then commit the resolution. Run 'git status' to see conflict details."
  }
}
```
````
