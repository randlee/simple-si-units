...
|-----------|-------|---------|
| Create | `sc-git-worktree-create` | JSON: success, path, branch, tracking_entry |
| Scan | `sc-git-worktree-scan` | JSON: success, worktrees list, recommendations |
| Cleanup | `sc-git-worktree-cleanup` | JSON: success, branch_deleted, tracking_update |
| Abort | `sc-git-worktree-abort` | JSON: success, worktree_removed, tracking_update |
| Update | `sc-git-worktree-update` | JSON: success, commits_pulled, conflicts (if any) |
