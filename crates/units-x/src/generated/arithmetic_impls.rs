...
impl_add_sub_rule!(i32, f32 => f64, infallible);
impl_add_sub_rule!(i32, f64 => f64, infallible);
impl_add_sub_rule!(f32, i32 => f64, infallible);
impl_add_sub_rule!(f32, f32 => f64, infallible);
...
impl_mul_rule!(i32, f32 => f64, infallible);
impl_mul_rule!(i32, f64 => f64, infallible);
impl_mul_rule!(f32, i32 => f64, infallible);
impl_mul_rule!(f32, f32 => f64, infallible);
...
impl_div_rule!(i32, f32 => f64, infallible);
impl_div_rule!(i32, f64 => f64, infallible);
impl_div_rule!(f32, i32 => f64, infallible);
