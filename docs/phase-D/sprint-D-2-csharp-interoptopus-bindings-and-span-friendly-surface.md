...
5. Generated or adjacent `System.Text.Json` JSON surface matching canonical fixtures
6. `.NET` packaging metadata under `dotnet/`, including `Directory.Build.props` version integration

## Dependencies

- Sprints A-3, A-5, C-1, D-1
...
3. C# JSON serialization matches the canonical wire shape without shape drift.
