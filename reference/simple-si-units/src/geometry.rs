    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_degrees(degrees: T) -> Self {
        Angle {
            rad: degrees * T::from(0.0174532925199433_f64),
        }
    }
    ...
    pub fn from_deg(deg: T) -> Self {
        Angle {
            rad: deg * T::from(0.0174532925199433_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Angle> for Angle<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Angle> for Angle<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::Angle) -> Self {
        Angle {
            rad: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Angle> for Angle<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Angle> for Angle<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Time<T>> for Angle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        AngularVelocity {
            radps: self.rad.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Angle<T>> for Angle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Angle<T>) -> Self::Output {
        SolidAngle {
            sr: self.rad.clone() * rhs.rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngle<T>> for Angle<T>
where
    T: NumLike,
{
    type Output = SolidAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngle<T>) -> Self::Output {
        SolidAngle {
            sr: self.rad.clone() / rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseSolidAngle<T>> for Angle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseSolidAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.rad.clone() * rhs.per_sr,
        }
    }
}
/// Multiplying a Angle by a InverseSolidAngle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.rad * rhs.per_sr.clone(),
        }
    }
}
/// Multiplying a Angle by a InverseSolidAngle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.rad.clone() * rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<SolidAngle<T>> for Angle<T>
where
    T: NumLike,
{
    type Output = InverseAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.rad.clone() / rhs.sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AngularVelocity<T>> for Angle<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AngularVelocity<T>) -> Self::Output {
        Time {
            s: self.rad.clone() / rhs.radps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for Angle<T>
where
    T: NumLike,
{
    type Output = AngularVelocity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        AngularVelocity {
            radps: self.rad.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAngularVelocity<T>> for Angle<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAngularVelocity<T>) -> Self::Output {
        Time {
            s: self.rad.clone() * rhs.s_per_rad,
        }
    }
}
/// Multiplying a Angle by a InverseAngularVelocity returns a value of type Time
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Time {
            s: self.rad * rhs.s_per_rad.clone(),
        }
    }
}
/// Multiplying a Angle by a InverseAngularVelocity returns a value of type Time
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Time {
            s: self.rad.clone() * rhs.s_per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Angle<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseAngle<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: T::from(self.clone()) / rhs.rad,
        }
    }
}
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: T::from(self) / rhs.rad.clone(),
        }
    }
}
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: T::from(self.clone()) / rhs.rad.clone(),
        }
    }
}
...
// 1/Angle -> InverseAngle
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
impl<T> core::ops::Div<Angle<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseAngle<T>;
...
// 1/Angle -> InverseAngle
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
impl<T> core::ops::Div<Angle<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseAngle<T>;
...
// 1/Angle -> InverseAngle
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
impl<T> core::ops::Div<Angle<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseAngle<T>;
...
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Angle<T>> for num_bigfloat::BigFloat
where
...
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Angle<T>> for num_complex::Complex32
where
...
/// Dividing a scalar value by a Angle unit value returns a value of type InverseAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Angle<T>> for num_complex::Complex64
where
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_square_cm(square_cm: T) -> Self {
        Area {
            m2: square_cm * T::from(0.0001_f64),
        }
    }
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Area> for Area<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Area> for Area<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Area> for Area<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Area> for Area<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Distance<T>> for Area<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Distance<T>> for Area<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Mul<InverseDistance<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        Distance {
            m: self.m2.clone() * rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        Volume {
            m3: self.m2.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMass<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2.clone() * rhs.per_kg,
        }
    }
}
/// Multiplying a Area by a InverseMass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2 * rhs.per_kg.clone(),
        }
    }
}
/// Multiplying a Area by a InverseMass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for Area<T>
where
    T: NumLike,
{
    type Output = AreaPerMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Mass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2.clone() / rhs.kg,
        }
    }
}
/// Dividing a Area by a Mass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2 / rhs.kg.clone(),
        }
    }
}
/// Dividing a Area by a Mass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.m2.clone() / rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerLumen<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        LuminousFlux {
            lm: self.m2.clone() / rhs.m2_per_lm,
        }
    }
}
/// Dividing a Area by a AreaPerLumen returns a value of type LuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        LuminousFlux {
            lm: self.m2 / rhs.m2_per_lm.clone(),
        }
    }
}
/// Dividing a Area by a AreaPerLumen returns a value of type LuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        LuminousFlux {
            lm: self.m2.clone() / rhs.m2_per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Illuminance<T>> for Area<T>
where
    T: NumLike,
{
    type Output = LuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Illuminance<T>) -> Self::Output {
        LuminousFlux {
            lm: self.m2.clone() * rhs.lux.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseLuminousFlux<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2.clone() * rhs.per_lm,
        }
    }
}
/// Multiplying a Area by a InverseLuminousFlux returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2 * rhs.per_lm.clone(),
        }
    }
}
/// Multiplying a Area by a InverseLuminousFlux returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2.clone() * rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2.clone() * rhs.per_Wb,
        }
    }
}
/// Multiplying a Area by a InverseMagneticFlux returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2 * rhs.per_Wb.clone(),
        }
    }
}
/// Multiplying a Area by a InverseMagneticFlux returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.m2.clone() / rhs.m2_per_Wb,
        }
    }
}
/// Dividing a Area by a InverseMagneticFluxDensity returns a value of type MagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.m2 / rhs.m2_per_Wb.clone(),
        }
    }
}
/// Dividing a Area by a InverseMagneticFluxDensity returns a value of type MagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.m2.clone() / rhs.m2_per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<LuminousFlux<T>> for Area<T>
where
    T: NumLike,
{
    type Output = AreaPerLumen<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: LuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2.clone() / rhs.lm,
        }
    }
}
/// Dividing a Area by a LuminousFlux returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2 / rhs.lm.clone(),
        }
    }
}
/// Dividing a Area by a LuminousFlux returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.m2.clone() / rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Area<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFluxDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: MagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2.clone() / rhs.Wb,
        }
    }
}
/// Dividing a Area by a MagneticFlux returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2 / rhs.Wb.clone(),
        }
    }
}
/// Dividing a Area by a MagneticFlux returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.m2.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFluxDensity<T>> for Area<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Mul<InverseVolume<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVolume<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m2.clone() * rhs.per_m3,
        }
    }
}
/// Multiplying a Area by a InverseVolume returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m2 * rhs.per_m3.clone(),
        }
    }
}
/// Multiplying a Area by a InverseVolume returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m2.clone() * rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Volume<T>> for Area<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m2.clone() / rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaDensity<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaDensity<T>) -> Self::Output {
        Mass {
            kg: self.m2.clone() * rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerMass<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaPerMass<T>) -> Self::Output {
        Mass {
            kg: self.m2.clone() / rhs.m2_per_kg,
        }
    }
}
/// Dividing a Area by a AreaPerMass returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Mass {
            kg: self.m2 / rhs.m2_per_kg.clone(),
        }
    }
}
/// Dividing a Area by a AreaPerMass returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Mass {
            kg: self.m2.clone() / rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Force<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Force<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m2.clone() / rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseForce<T>> for Area<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseForce<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m2.clone() * rhs.per_N,
        }
    }
}
/// Multiplying a Area by a InverseForce returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseForce<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m2 * rhs.per_N.clone(),
        }
    }
}
/// Multiplying a Area by a InverseForce returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseForce<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m2.clone() * rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMomentOfInertia<T>> for Area<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMomentOfInertia<T>) -> Self::Output {
        InverseMass {
            per_kg: self.m2.clone() * rhs.per_kgm2,
        }
    }
}
/// Multiplying a Area by a InverseMomentOfInertia returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        InverseMass {
            per_kg: self.m2 * rhs.per_kgm2.clone(),
        }
    }
}
/// Multiplying a Area by a InverseMomentOfInertia returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        InverseMass {
            per_kg: self.m2.clone() * rhs.per_kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePressure<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Force {
            N: self.m2.clone() / rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MomentOfInertia<T>> for Area<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MomentOfInertia<T>) -> Self::Output {
        InverseMass {
            per_kg: self.m2.clone() / rhs.kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Pressure<T>> for Area<T>
where
    T: NumLike,
{
    type Output = Force<T>;
...
impl<T> core::ops::Div<Area<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Area<T>) -> Self::Output {
        InverseArea {
            per_m2: T::from(self.clone()) / rhs.m2,
        }
    }
}
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseArea {
            per_m2: T::from(self) / rhs.m2.clone(),
        }
    }
}
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseArea {
            per_m2: T::from(self.clone()) / rhs.m2.clone(),
        }
    }
}
...
// 1/Area -> InverseArea
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
impl<T> core::ops::Div<Area<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseArea<T>;
...
// 1/Area -> InverseArea
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
impl<T> core::ops::Div<Area<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseArea<T>;
...
// 1/Area -> InverseArea
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
impl<T> core::ops::Div<Area<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseArea<T>;
...
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Area<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseArea<T>;
...
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Area<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseArea<T>;
...
/// Dividing a scalar value by a Area unit value returns a value of type InverseArea
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Area<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_radians(per_radians: T) -> Self {
        InverseAngle {
            per_rad: per_radians,
        }
    }
    ...
    /// Returns a copy of this inverse angle value in inverse radians
    pub fn to_per_radians(&self) -> T {
        self.per_rad.clone()
    }
}

impl<T> fmt::Display for InverseAngle<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_degrees(per_degrees: T) -> Self {
        InverseAngle {
            per_rad: per_degrees * T::from(57.2957795130823_f64),
        }
    }
    ...
    pub fn from_per_deg(per_deg: T) -> Self {
        InverseAngle {
            per_rad: per_deg * T::from(57.2957795130823_f64),
        }
    }
}
...
impl core::ops::Mul<InverseAngle<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: InverseAngle<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAngle {
            per_rad: self.clone() * rhs.per_rad,
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&InverseAngle<num_bigfloat::BigFloat>> for num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseAngle<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAngle {
            per_rad: self * rhs.per_rad.clone(),
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&InverseAngle<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseAngle<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAngle {
            per_rad: self.clone() * rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseAngle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Time<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad.clone() * rhs.s,
        }
    }
}
/// Multiplying a InverseAngle by a Time returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad * rhs.s.clone(),
        }
    }
}
/// Multiplying a InverseAngle by a Time returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Angle<T>> for InverseAngle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Angle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad.clone() / rhs.rad,
        }
    }
}
/// Dividing a InverseAngle by a Angle returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad / rhs.rad.clone(),
        }
    }
}
/// Dividing a InverseAngle by a Angle returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad.clone() / rhs.rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAngle<T>> for InverseAngle<T>
where
    T: NumLike,
{
    type Output = InverseSolidAngle<T>;
    fn mul(self, rhs: InverseAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad * rhs.per_rad,
        }
    }
}
/// Multiplying a InverseAngle by a InverseAngle returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad.clone() * rhs.per_rad,
        }
    }
}
/// Multiplying a InverseAngle by a InverseAngle returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad * rhs.per_rad.clone(),
        }
    }
}
/// Multiplying a InverseAngle by a InverseAngle returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_rad.clone() * rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSolidAngle<T>> for InverseAngle<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseSolidAngle<T>) -> Self::Output {
        Angle {
            rad: self.per_rad.clone() / rhs.per_sr,
        }
    }
}
/// Dividing a InverseAngle by a InverseSolidAngle returns a value of type Angle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        Angle {
            rad: self.per_rad / rhs.per_sr.clone(),
        }
    }
}
/// Dividing a InverseAngle by a InverseSolidAngle returns a value of type Angle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        Angle {
            rad: self.per_rad.clone() / rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<SolidAngle<T>> for InverseAngle<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SolidAngle<T>) -> Self::Output {
        Angle {
            rad: self.per_rad.clone() * rhs.sr.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AngularVelocity<T>> for InverseAngle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad.clone() * rhs.radps,
        }
    }
}
/// Multiplying a InverseAngle by a AngularVelocity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad * rhs.radps.clone(),
        }
    }
}
/// Multiplying a InverseAngle by a AngularVelocity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad.clone() * rhs.radps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseAngle<T>
where
    T: NumLike,
{
    type Output = InverseAngularVelocity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Frequency<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad.clone() / rhs.Hz,
        }
    }
}
/// Dividing a InverseAngle by a Frequency returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad / rhs.Hz.clone(),
        }
    }
}
/// Dividing a InverseAngle by a Frequency returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.per_rad.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngularVelocity<T>> for InverseAngle<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad.clone() / rhs.s_per_rad,
        }
    }
}
/// Dividing a InverseAngle by a InverseAngularVelocity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad / rhs.s_per_rad.clone(),
        }
    }
}
/// Dividing a InverseAngle by a InverseAngularVelocity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_rad.clone() / rhs.s_per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngle<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Angle<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseAngle<T>) -> Self::Output {
        Angle {
            rad: T::from(self.clone()) / rhs.per_rad,
        }
    }
}
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseAngle<T>) -> Self::Output {
        Angle {
            rad: T::from(self) / rhs.per_rad.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseAngle<T>) -> Self::Output {
        Angle {
            rad: T::from(self.clone()) / rhs.per_rad.clone(),
        }
    }
}
...
// 1/InverseAngle -> Angle
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
impl<T> core::ops::Div<InverseAngle<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Angle<T>;
...
// 1/InverseAngle -> Angle
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
impl<T> core::ops::Div<InverseAngle<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Angle<T>;
...
// 1/InverseAngle -> Angle
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
impl<T> core::ops::Div<InverseAngle<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Angle<T>;
...
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseAngle<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Angle<T>;
...
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseAngle<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Angle<T>;
...
/// Dividing a scalar value by a InverseAngle unit value returns a value of type Angle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseAngle<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Angle<T>;
...
impl<T> fmt::Display for InverseArea<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_cm2(per_cm2: T) -> Self {
        InverseArea {
            per_m2: per_cm2 * T::from(10000.0_f64),
        }
    }
    ...
    pub fn from_per_square_cm(per_square_cm: T) -> Self {
        InverseArea {
            per_m2: per_square_cm * T::from(10000.0_f64),
        }
    }
    ...
    pub fn from_per_mm2(per_mm2: T) -> Self {
        InverseArea {
            per_m2: per_mm2 * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_um2(per_um2: T) -> Self {
        InverseArea {
            per_m2: per_um2 * T::from(1000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_nm2(per_nm2: T) -> Self {
        InverseArea {
            per_m2: per_nm2 * T::from(1e+18_f64),
        }
    }
    ...
    pub fn from_per_km2(per_km2: T) -> Self {
        InverseArea {
            per_m2: per_km2 * T::from(1e-06_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseArea<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseArea<num_bigfloat::BigFloat>) -> Self::Output {
        InverseArea {
            per_m2: self.clone() * rhs.per_m2.clone(),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ArealNumberDensity> for InverseArea<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::ArealNumberDensity {
        uom::si::f32::ArealNumberDensity::new::<uom::si::areal_number_density::per_square_meter>(
            self.per_m2.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ArealNumberDensity> for InverseArea<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::ArealNumberDensity) -> Self {
        InverseArea {
            per_m2: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ArealNumberDensity> for InverseArea<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::ArealNumberDensity {
        uom::si::f64::ArealNumberDensity::new::<uom::si::areal_number_density::per_square_meter>(
            self.per_m2.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ArealNumberDensity> for InverseArea<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Distance<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Distance<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m2.clone() * rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Distance<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Distance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2.clone() / rhs.m,
        }
    }
}
/// Dividing a InverseArea by a Distance returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Distance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2 / rhs.m.clone(),
        }
    }
}
/// Dividing a InverseArea by a Distance returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Distance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2.clone() / rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDistance<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2.clone() * rhs.per_m,
        }
    }
}
/// Multiplying a InverseArea by a InverseDistance returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2 * rhs.per_m.clone(),
        }
    }
}
/// Multiplying a InverseArea by a InverseDistance returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m2.clone() * rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m2.clone() / rhs.per_m,
        }
    }
}
/// Dividing a InverseArea by a InverseDistance returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m2 / rhs.per_m.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseDistance returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m2.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMass<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2.clone() / rhs.per_kg,
        }
    }
}
/// Dividing a InverseArea by a InverseMass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2 / rhs.per_kg.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseMass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2.clone() / rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Mass<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = AreaDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Mass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2.clone() * rhs.kg,
        }
    }
}
/// Multiplying a InverseArea by a Mass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2 * rhs.kg.clone(),
        }
    }
}
/// Multiplying a InverseArea by a Mass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.per_m2.clone() * rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaPerLumen<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerLumen<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2 * rhs.m2_per_lm,
        }
    }
}
/// Multiplying a InverseArea by a AreaPerLumen returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerLumen<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2.clone() * rhs.m2_per_lm,
        }
    }
}
/// Multiplying a InverseArea by a AreaPerLumen returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2 * rhs.m2_per_lm.clone(),
        }
    }
}
/// Multiplying a InverseArea by a AreaPerLumen returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2.clone() * rhs.m2_per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Illuminance<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseLuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Illuminance<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2.clone() / rhs.lux,
        }
    }
}
/// Dividing a InverseArea by a Illuminance returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Illuminance<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2 / rhs.lux.clone(),
        }
    }
}
/// Dividing a InverseArea by a Illuminance returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Illuminance<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_m2.clone() / rhs.lux.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminousFlux<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        Illuminance {
            lux: self.per_m2.clone() / rhs.per_lm,
        }
    }
}
/// Dividing a InverseArea by a InverseLuminousFlux returns a value of type Illuminance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Illuminance {
            lux: self.per_m2 / rhs.per_lm.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseLuminousFlux returns a value of type Illuminance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Illuminance {
            lux: self.per_m2.clone() / rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        MagneticFluxDensity {
            T: self.per_m2.clone() / rhs.per_Wb,
        }
    }
}
/// Dividing a InverseArea by a InverseMagneticFlux returns a value of type MagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        MagneticFluxDensity {
            T: self.per_m2 / rhs.per_Wb.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseMagneticFlux returns a value of type MagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        MagneticFluxDensity {
            T: self.per_m2.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFluxDensity<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2 * rhs.m2_per_Wb,
        }
    }
}
/// Multiplying a InverseArea by a InverseMagneticFluxDensity returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2.clone() * rhs.m2_per_Wb,
        }
    }
}
/// Multiplying a InverseArea by a InverseMagneticFluxDensity returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2 * rhs.m2_per_Wb.clone(),
        }
    }
}
/// Multiplying a InverseArea by a InverseMagneticFluxDensity returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2.clone() * rhs.m2_per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<LuminousFlux<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Illuminance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &LuminousFlux<T>) -> Self::Output {
        Illuminance {
            lux: self.per_m2.clone() * rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = MagneticFluxDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        MagneticFluxDensity {
            T: self.per_m2.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFluxDensity<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2.clone() / rhs.T,
        }
    }
}
/// Dividing a InverseArea by a MagneticFluxDensity returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2 / rhs.T.clone(),
        }
    }
}
/// Dividing a InverseArea by a MagneticFluxDensity returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_m2.clone() / rhs.T.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVolume<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        Distance {
            m: self.per_m2.clone() / rhs.per_m3,
        }
    }
}
/// Dividing a InverseArea by a InverseVolume returns a value of type Distance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Distance {
            m: self.per_m2 / rhs.per_m3.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseVolume returns a value of type Distance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Distance {
            m: self.per_m2.clone() / rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Volume<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        Distance {
            m: self.per_m2.clone() * rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaDensity<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaDensity<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2.clone() / rhs.kgpm2,
        }
    }
}
/// Dividing a InverseArea by a AreaDensity returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaDensity<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2 / rhs.kgpm2.clone(),
        }
    }
}
/// Dividing a InverseArea by a AreaDensity returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaDensity<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2.clone() / rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaPerMass<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    fn mul(self, rhs: AreaPerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2 * rhs.m2_per_kg,
        }
    }
}
/// Multiplying a InverseArea by a AreaPerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2.clone() * rhs.m2_per_kg,
        }
    }
}
/// Multiplying a InverseArea by a AreaPerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2 * rhs.m2_per_kg.clone(),
        }
    }
}
/// Multiplying a InverseArea by a AreaPerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m2.clone() * rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Force<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Force<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m2.clone() * rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseForce<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Pressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseForce<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m2.clone() / rhs.per_N,
        }
    }
}
/// Dividing a InverseArea by a InverseForce returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m2 / rhs.per_N.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseForce returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m2.clone() / rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMomentOfInertia<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMomentOfInertia<T>) -> Self::Output {
        Mass {
            kg: self.per_m2.clone() / rhs.per_kgm2,
        }
    }
}
/// Dividing a InverseArea by a InverseMomentOfInertia returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        Mass {
            kg: self.per_m2 / rhs.per_kgm2.clone(),
        }
    }
}
/// Dividing a InverseArea by a InverseMomentOfInertia returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        Mass {
            kg: self.per_m2.clone() / rhs.per_kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InversePressure<T>> for InverseArea<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InversePressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2.clone() * rhs.per_Pa,
        }
    }
}
/// Multiplying a InverseArea by a InversePressure returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2 * rhs.per_Pa.clone(),
        }
    }
}
/// Multiplying a InverseArea by a InversePressure returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2.clone() * rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MomentOfInertia<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MomentOfInertia<T>) -> Self::Output {
        Mass {
            kg: self.per_m2.clone() * rhs.kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Pressure<T>> for InverseArea<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Pressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2.clone() / rhs.Pa,
        }
    }
}
/// Dividing a InverseArea by a Pressure returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Pressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2 / rhs.Pa.clone(),
        }
    }
}
/// Dividing a InverseArea by a Pressure returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Pressure<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_m2.clone() / rhs.Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Area<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        Area {
            m2: T::from(self.clone()) / rhs.per_m2,
        }
    }
}
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        Area {
            m2: T::from(self) / rhs.per_m2.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        Area {
            m2: T::from(self.clone()) / rhs.per_m2.clone(),
        }
    }
}
...
// 1/InverseArea -> Area
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
impl<T> core::ops::Div<InverseArea<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Area<T>;
...
// 1/InverseArea -> Area
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
impl<T> core::ops::Div<InverseArea<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Area<T>;
...
// 1/InverseArea -> Area
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
impl<T> core::ops::Div<InverseArea<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Area<T>;
...
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseArea<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Area<T>;
...
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseArea<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Area<T>;
...
/// Dividing a scalar value by a InverseArea unit value returns a value of type Area
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseArea<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_sr(per_sr: T) -> Self {
        InverseSolidAngle { per_sr: per_sr }
    }

    /// Returns a copy of this inverse solid angle value in inverse steradians
    pub fn to_per_sr(&self) -> T {
        self.per_sr.clone()
    }
    ...
    pub fn from_per_steradians(per_steradians: T) -> Self {
        InverseSolidAngle {
            per_sr: per_steradians,
        }
    }

    /// Returns a copy of this inverse solid angle value in inverse steradians
    pub fn to_per_steradians(&self) -> T {
        self.per_sr.clone()
    }
}

impl<T> fmt::Display for InverseSolidAngle<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl core::ops::Mul<&InverseSolidAngle<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseSolidAngle<num_bigfloat::BigFloat>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.clone() * rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseLuminosity<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    type Output = InverseLuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseLuminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr.clone() * rhs.per_cd,
        }
    }
}
/// Multiplying a InverseSolidAngle by a InverseLuminosity returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr * rhs.per_cd.clone(),
        }
    }
}
/// Multiplying a InverseSolidAngle by a InverseLuminosity returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr.clone() * rhs.per_cd.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Luminosity<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    type Output = InverseLuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Luminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr.clone() / rhs.cd,
        }
    }
}
/// Dividing a InverseSolidAngle by a Luminosity returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr / rhs.cd.clone(),
        }
    }
}
/// Dividing a InverseSolidAngle by a Luminosity returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_sr.clone() / rhs.cd.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminousFlux<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        Luminosity {
            cd: self.per_sr.clone() / rhs.per_lm,
        }
    }
}
/// Dividing a InverseSolidAngle by a InverseLuminousFlux returns a value of type Luminosity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Luminosity {
            cd: self.per_sr / rhs.per_lm.clone(),
        }
    }
}
/// Dividing a InverseSolidAngle by a InverseLuminousFlux returns a value of type Luminosity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Luminosity {
            cd: self.per_sr.clone() / rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<LuminousFlux<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    type Output = Luminosity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &LuminousFlux<T>) -> Self::Output {
        Luminosity {
            cd: self.per_sr.clone() * rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Angle<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    type Output = InverseAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr.clone() * rhs.rad,
        }
    }
}
/// Multiplying a InverseSolidAngle by a Angle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr * rhs.rad.clone(),
        }
    }
}
/// Multiplying a InverseSolidAngle by a Angle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr.clone() * rhs.rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngle<T>> for InverseSolidAngle<T>
where
    T: NumLike,
{
    type Output = InverseAngle<T>;
    fn div(self, rhs: InverseAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr / rhs.per_rad,
        }
    }
}
/// Dividing a InverseSolidAngle by a InverseAngle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr.clone() / rhs.per_rad,
        }
    }
}
/// Dividing a InverseSolidAngle by a InverseAngle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr / rhs.per_rad.clone(),
        }
    }
}
/// Dividing a InverseSolidAngle by a InverseAngle returns a value of type InverseAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseAngle {
            per_rad: self.per_sr.clone() / rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSolidAngle<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = SolidAngle<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseSolidAngle<T>) -> Self::Output {
        SolidAngle {
            sr: T::from(self.clone()) / rhs.per_sr,
        }
    }
}
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        SolidAngle {
            sr: T::from(self) / rhs.per_sr.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        SolidAngle {
            sr: T::from(self.clone()) / rhs.per_sr.clone(),
        }
    }
}
...
// 1/InverseSolidAngle -> SolidAngle
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
impl<T> core::ops::Div<InverseSolidAngle<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = SolidAngle<T>;
...
// 1/InverseSolidAngle -> SolidAngle
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
impl<T> core::ops::Div<InverseSolidAngle<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = SolidAngle<T>;
...
// 1/InverseSolidAngle -> SolidAngle
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
impl<T> core::ops::Div<InverseSolidAngle<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = SolidAngle<T>;
...
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseSolidAngle<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = SolidAngle<T>;
...
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseSolidAngle<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = SolidAngle<T>;
...
/// Dividing a scalar value by a InverseSolidAngle unit value returns a value of type SolidAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseSolidAngle<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = SolidAngle<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_m3(per_m3: T) -> Self {
        InverseVolume { per_m3: per_m3 }
    }

    /// Returns a copy of this inverse volume value in inverse cubic meters
    pub fn to_per_m3(&self) -> T {
        self.per_m3.clone()
    }
    ...
    pub fn from_per_cubic_meter(per_cubic_meter: T) -> Self {
        InverseVolume {
            per_m3: per_cubic_meter,
        }
    }

    /// Returns a copy of this inverse volume value in inverse cubic meters
    pub fn to_per_cubic_meter(&self) -> T {
        self.per_m3.clone()
    }
    ...
    pub fn from_per_kL(per_kL: T) -> Self {
        InverseVolume { per_m3: per_kL }
    }

    /// Returns a copy of this inverse volume value in inverse kiloliters
    pub fn to_per_kL(&self) -> T {
        self.per_m3.clone()
    }
}

impl<T> fmt::Display for InverseVolume<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_cc(per_cc: T) -> Self {
        InverseVolume {
            per_m3: per_cc * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_L(per_L: T) -> Self {
        InverseVolume {
            per_m3: per_L * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_liters(per_liters: T) -> Self {
        InverseVolume {
            per_m3: per_liters * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_mL(per_mL: T) -> Self {
        InverseVolume {
            per_m3: per_mL * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_uL(per_uL: T) -> Self {
        InverseVolume {
            per_m3: per_uL * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_nL(per_nL: T) -> Self {
        InverseVolume {
            per_m3: per_nL * T::from(1000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_pL(per_pL: T) -> Self {
        InverseVolume {
            per_m3: per_pL * T::from(1000000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_ML(per_ML: T) -> Self {
        InverseVolume {
            per_m3: per_ML * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_GL(per_GL: T) -> Self {
        InverseVolume {
            per_m3: per_GL * T::from(1e-06_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseVolume<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseVolume<num_bigfloat::BigFloat>) -> Self::Output {
        InverseVolume {
            per_m3: self.clone() * rhs.per_m3.clone(),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::VolumetricNumberDensity> for InverseVolume<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::VolumetricNumberDensity {
        uom::si::f32::VolumetricNumberDensity::new::<
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::VolumetricNumberDensity> for InverseVolume<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::VolumetricNumberDensity) -> Self {
        InverseVolume {
            per_m3: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::VolumetricNumberDensity> for InverseVolume<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::VolumetricNumberDensity {
        uom::si::f64::VolumetricNumberDensity::new::<
            uom::si::volumetric_number_density::per_cubic_meter,
        >(self.per_m3.into())
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::VolumetricNumberDensity> for InverseVolume<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Amount<T>> for InverseVolume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Amount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3.clone() * rhs.mol,
        }
    }
}
/// Multiplying a InverseVolume by a Amount returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Amount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3 * rhs.mol.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a Amount returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Amount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3.clone() * rhs.mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Distance<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Distance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3.clone() * rhs.m,
        }
    }
}
/// Multiplying a InverseVolume by a Distance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Distance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3 * rhs.m.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a Distance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Distance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3.clone() * rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAmount<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Concentration<T>;
    fn div(self, rhs: InverseAmount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3 / rhs.per_mol,
        }
    }
}
/// Dividing a InverseVolume by a InverseAmount returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAmount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3.clone() / rhs.per_mol,
        }
    }
}
/// Dividing a InverseVolume by a InverseAmount returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3 / rhs.per_mol.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseAmount returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Concentration {
            molpm3: self.per_m3.clone() / rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3.clone() / rhs.per_m,
        }
    }
}
/// Dividing a InverseVolume by a InverseDistance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3 / rhs.per_m.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseDistance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m3.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMass<T>> for InverseVolume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3.clone() / rhs.per_kg,
        }
    }
}
/// Dividing a InverseVolume by a InverseMass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3 / rhs.per_kg.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseMass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3.clone() / rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Mass<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Mass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3.clone() * rhs.kg,
        }
    }
}
/// Multiplying a InverseVolume by a Mass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3 * rhs.kg.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a Mass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m3.clone() * rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Concentration<T>> for InverseVolume<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: Concentration<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3 / rhs.molpm3,
        }
    }
}
/// Dividing a InverseVolume by a Concentration returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Concentration<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3.clone() / rhs.molpm3,
        }
    }
}
/// Dividing a InverseVolume by a Concentration returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Concentration<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3 / rhs.molpm3.clone(),
        }
    }
}
/// Dividing a InverseVolume by a Concentration returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Concentration<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3.clone() / rhs.molpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MolarVolume<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseAmount<T>;
    fn mul(self, rhs: MolarVolume<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3 * rhs.m3_per_mol,
        }
    }
}
/// Multiplying a InverseVolume by a MolarVolume returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: MolarVolume<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3.clone() * rhs.m3_per_mol,
        }
    }
}
/// Multiplying a InverseVolume by a MolarVolume returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarVolume<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3 * rhs.m3_per_mol.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a MolarVolume returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarVolume<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_m3.clone() * rhs.m3_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Area<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3.clone() * rhs.m2,
        }
    }
}
/// Multiplying a InverseVolume by a Area returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3 * rhs.m2.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a Area returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3.clone() / rhs.per_m2,
        }
    }
}
/// Dividing a InverseVolume by a InverseArea returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3 / rhs.per_m2.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseArea returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_m3.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Density<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Density<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3.clone() / rhs.kgpm3,
        }
    }
}
/// Dividing a InverseVolume by a Density returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3 / rhs.kgpm3.clone(),
        }
    }
}
/// Dividing a InverseVolume by a Density returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3.clone() / rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Pressure<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Pressure<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Pressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseEnergy<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() / rhs.per_J,
        }
    }
}
/// Dividing a InverseVolume by a InverseEnergy returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3 / rhs.per_J.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseEnergy returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = Pressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTorque<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() / rhs.per_Nm,
        }
    }
}
/// Dividing a InverseVolume by a InverseTorque returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3 / rhs.per_Nm.clone(),
        }
    }
}
/// Dividing a InverseVolume by a InverseTorque returns a value of type Pressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Pressure {
            Pa: self.per_m3.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InversePressure<T>> for InverseVolume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InversePressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3.clone() * rhs.per_Pa,
        }
    }
}
/// Multiplying a InverseVolume by a InversePressure returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3 * rhs.per_Pa.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a InversePressure returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3.clone() * rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Pressure<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Pressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3.clone() / rhs.Pa,
        }
    }
}
/// Dividing a InverseVolume by a Pressure returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Pressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3 / rhs.Pa.clone(),
        }
    }
}
/// Dividing a InverseVolume by a Pressure returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Pressure<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m3.clone() / rhs.Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<VolumePerMass<T>> for InverseVolume<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3 * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseVolume by a VolumePerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3.clone() * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseVolume by a VolumePerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3 * rhs.m3_per_kg.clone(),
        }
    }
}
/// Multiplying a InverseVolume by a VolumePerMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_m3.clone() * rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVolume<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Volume<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        Volume {
            m3: T::from(self.clone()) / rhs.per_m3,
        }
    }
}
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Volume {
            m3: T::from(self) / rhs.per_m3.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Volume {
            m3: T::from(self.clone()) / rhs.per_m3.clone(),
        }
    }
}
...
// 1/InverseVolume -> Volume
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
impl<T> core::ops::Div<InverseVolume<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Volume<T>;
...
// 1/InverseVolume -> Volume
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
impl<T> core::ops::Div<InverseVolume<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Volume<T>;
...
// 1/InverseVolume -> Volume
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
impl<T> core::ops::Div<InverseVolume<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Volume<T>;
...
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseVolume<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Volume<T>;
...
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseVolume<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Volume<T>;
...
/// Dividing a scalar value by a InverseVolume unit value returns a value of type Volume
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseVolume<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Volume<T>;
...
impl<T> fmt::Display for SolidAngle<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::SolidAngle> for SolidAngle<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::SolidAngle> for SolidAngle<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::SolidAngle> for SolidAngle<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::SolidAngle> for SolidAngle<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<InverseLuminosity<T>> for SolidAngle<T>
where
    T: NumLike,
{
    type Output = LuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        LuminousFlux {
            lm: self.sr.clone() / rhs.per_cd.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Luminosity<T>> for SolidAngle<T>
where
    T: NumLike,
{
    type Output = LuminousFlux<T>;
...
impl<T> core::ops::Mul<InverseLuminousFlux<T>> for SolidAngle<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.sr.clone() * rhs.per_lm,
        }
    }
}
/// Multiplying a SolidAngle by a InverseLuminousFlux returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.sr * rhs.per_lm.clone(),
        }
    }
}
/// Multiplying a SolidAngle by a InverseLuminousFlux returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.sr.clone() * rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<LuminousFlux<T>> for SolidAngle<T>
where
    T: NumLike,
{
    type Output = InverseLuminosity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.sr.clone() / rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Angle<T>> for SolidAngle<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        Angle {
            rad: self.sr.clone() / rhs.rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAngle<T>> for SolidAngle<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngle<T>) -> Self::Output {
        Angle {
            rad: self.sr.clone() * rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<SolidAngle<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseSolidAngle<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: SolidAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: T::from(self.clone()) / rhs.sr,
        }
    }
}
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: T::from(self) / rhs.sr.clone(),
        }
    }
}
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: T::from(self.clone()) / rhs.sr.clone(),
        }
    }
}
...
// 1/SolidAngle -> InverseSolidAngle
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
impl<T> core::ops::Div<SolidAngle<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseSolidAngle<T>;
...
// 1/SolidAngle -> InverseSolidAngle
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
impl<T> core::ops::Div<SolidAngle<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseSolidAngle<T>;
...
// 1/SolidAngle -> InverseSolidAngle
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
impl<T> core::ops::Div<SolidAngle<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseSolidAngle<T>;
...
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<SolidAngle<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseSolidAngle<T>;
...
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<SolidAngle<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseSolidAngle<T>;
...
/// Dividing a scalar value by a SolidAngle unit value returns a value of type InverseSolidAngle
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<SolidAngle<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseSolidAngle<T>;
...
impl<T> fmt::Display for Volume<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Volume> for Volume<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Volume> for Volume<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Volume> for Volume<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Volume> for Volume<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Amount<T>> for Volume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Amount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3.clone() / rhs.mol,
        }
    }
}
/// Dividing a Volume by a Amount returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3 / rhs.mol.clone(),
        }
    }
}
/// Dividing a Volume by a Amount returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3.clone() / rhs.mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Distance<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Area<T>;
...
impl<T> core::ops::Mul<InverseAmount<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = MolarVolume<T>;
    fn mul(self, rhs: InverseAmount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3 * rhs.per_mol,
        }
    }
}
/// Multiplying a Volume by a InverseAmount returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAmount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3.clone() * rhs.per_mol,
        }
    }
}
/// Multiplying a Volume by a InverseAmount returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3 * rhs.per_mol.clone(),
        }
    }
}
/// Multiplying a Volume by a InverseAmount returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.m3.clone() * rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDistance<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        Area {
            m2: self.m3.clone() * rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMass<T>> for Volume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3.clone() * rhs.per_kg,
        }
    }
}
/// Multiplying a Volume by a InverseMass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3 * rhs.per_kg.clone(),
        }
    }
}
/// Multiplying a Volume by a InverseMass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = VolumePerMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Mass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3.clone() / rhs.kg,
        }
    }
}
/// Dividing a Volume by a Mass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3 / rhs.kg.clone(),
        }
    }
}
/// Dividing a Volume by a Mass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m3.clone() / rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Concentration<T>> for Volume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Concentration<T>) -> Self::Output {
        Amount {
            mol: self.m3.clone() * rhs.molpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MolarVolume<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: MolarVolume<T>) -> Self::Output {
        Amount {
            mol: self.m3.clone() / rhs.m3_per_mol,
        }
    }
}
/// Dividing a Volume by a MolarVolume returns a value of type Amount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarVolume<T>) -> Self::Output {
        Amount {
            mol: self.m3 / rhs.m3_per_mol.clone(),
        }
    }
}
/// Dividing a Volume by a MolarVolume returns a value of type Amount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarVolume<T>) -> Self::Output {
        Amount {
            mol: self.m3.clone() / rhs.m3_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
...
impl<T> core::ops::Mul<InverseArea<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        Distance {
            m: self.m3.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Density<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Density<T>) -> Self::Output {
        Mass {
            kg: self.m3.clone() * rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Energy<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseEnergy<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() * rhs.per_J,
        }
    }
}
/// Multiplying a Volume by a InverseEnergy returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3 * rhs.per_J.clone(),
        }
    }
}
/// Multiplying a Volume by a InverseEnergy returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseTorque<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() * rhs.per_Nm,
        }
    }
}
/// Multiplying a Volume by a InverseTorque returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3 * rhs.per_Nm.clone(),
        }
    }
}
/// Multiplying a Volume by a InverseTorque returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.m3.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePressure<T>> for Volume<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Energy {
            J: self.m3.clone() / rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Pressure<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<VolumePerMass<T>> for Volume<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: VolumePerMass<T>) -> Self::Output {
        Mass {
            kg: self.m3.clone() / rhs.m3_per_kg,
        }
    }
}
/// Dividing a Volume by a VolumePerMass returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        Mass {
            kg: self.m3 / rhs.m3_per_kg.clone(),
        }
    }
}
/// Dividing a Volume by a VolumePerMass returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        Mass {
            kg: self.m3.clone() / rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Volume<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseVolume<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Volume<T>) -> Self::Output {
        InverseVolume {
            per_m3: T::from(self.clone()) / rhs.m3,
        }
    }
}
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        InverseVolume {
            per_m3: T::from(self) / rhs.m3.clone(),
        }
    }
}
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        InverseVolume {
            per_m3: T::from(self.clone()) / rhs.m3.clone(),
        }
    }
}
...
// 1/Volume -> InverseVolume
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
impl<T> core::ops::Div<Volume<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseVolume<T>;
...
// 1/Volume -> InverseVolume
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
impl<T> core::ops::Div<Volume<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseVolume<T>;
...
// 1/Volume -> InverseVolume
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
impl<T> core::ops::Div<Volume<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseVolume<T>;
...
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Volume<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseVolume<T>;
...
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Volume<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseVolume<T>;
...
/// Dividing a scalar value by a Volume unit value returns a value of type InverseVolume
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Volume<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseVolume<T>;
