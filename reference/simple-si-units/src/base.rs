    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_count(count: T) -> Self {
        Amount {
            mol: count * T::from(1.66053906717385e-24_f64),
        }
    }
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::AmountOfSubstance> for Amount<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::AmountOfSubstance> for Amount<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::AmountOfSubstance) -> Self {
        Amount {
            mol: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::AmountOfSubstance> for Amount<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::AmountOfSubstance> for Amount<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<InverseMass<T>> for Amount<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMass<T>) -> Self::Output {
        Molality {
            molpkg: self.mol.clone() * rhs.per_kg,
        }
    }
}
/// Multiplying a Amount by a InverseMass returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        Molality {
            molpkg: self.mol * rhs.per_kg.clone(),
        }
    }
}
/// Multiplying a Amount by a InverseMass returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        Molality {
            molpkg: self.mol.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Molality<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        Molality {
            molpkg: self.mol.clone() / rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for Amount<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        CatalyticActivity {
            molps: self.mol.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Div<CatalyticActivity<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &CatalyticActivity<T>) -> Self::Output {
        Time {
            s: self.mol.clone() / rhs.molps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Concentration<T>> for Amount<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Concentration<T>) -> Self::Output {
        Volume {
            m3: self.mol.clone() / rhs.molpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCatalyticActivity<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseCatalyticActivity<T>) -> Self::Output {
        Time {
            s: self.mol.clone() * rhs.s_per_mol,
        }
    }
}
/// Multiplying a Amount by a InverseCatalyticActivity returns a value of type Time
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Time {
            s: self.mol * rhs.s_per_mol.clone(),
        }
    }
}
/// Multiplying a Amount by a InverseCatalyticActivity returns a value of type Time
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Time {
            s: self.mol.clone() * rhs.s_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Molality<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Molality<T>) -> Self::Output {
        Mass {
            kg: self.mol.clone() / rhs.molpkg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MolarMass<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarMass<T>) -> Self::Output {
        Mass {
            kg: self.mol.clone() * rhs.kgpmol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MolarVolume<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: MolarVolume<T>) -> Self::Output {
        Volume {
            m3: self.mol.clone() * rhs.m3_per_mol,
        }
    }
}
/// Multiplying a Amount by a MolarVolume returns a value of type Volume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarVolume<T>) -> Self::Output {
        Volume {
            m3: self.mol * rhs.m3_per_mol.clone(),
        }
    }
}
/// Multiplying a Amount by a MolarVolume returns a value of type Volume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarVolume<T>) -> Self::Output {
        Volume {
            m3: self.mol.clone() * rhs.m3_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVolume<T>> for Amount<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVolume<T>) -> Self::Output {
        Concentration {
            molpm3: self.mol.clone() * rhs.per_m3,
        }
    }
}
/// Multiplying a Amount by a InverseVolume returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        Concentration {
            molpm3: self.mol * rhs.per_m3.clone(),
        }
    }
}
/// Multiplying a Amount by a InverseVolume returns a value of type Concentration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        Concentration {
            molpm3: self.mol.clone() * rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Volume<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = Concentration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        Concentration {
            molpm3: self.mol.clone() / rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for Amount<T>
where
    T: NumLike,
{
    type Output = CatalyticActivity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        CatalyticActivity {
            molps: self.mol.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Amount<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Amount<T>) -> Self::Output {
        InverseAmount {
            per_mol: T::from(self.clone()) / rhs.mol,
        }
    }
}
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        InverseAmount {
            per_mol: T::from(self) / rhs.mol.clone(),
        }
    }
}
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        InverseAmount {
            per_mol: T::from(self.clone()) / rhs.mol.clone(),
        }
    }
}
...
// 1/Amount -> InverseAmount
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
impl<T> core::ops::Div<Amount<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseAmount<T>;
...
// 1/Amount -> InverseAmount
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
impl<T> core::ops::Div<Amount<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseAmount<T>;
...
// 1/Amount -> InverseAmount
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
impl<T> core::ops::Div<Amount<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseAmount<T>;
...
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Amount<T>> for num_bigfloat::BigFloat
where
...
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Amount<T>> for num_complex::Complex32
where
...
/// Dividing a scalar value by a Amount unit value returns a value of type InverseAmount
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Amount<T>> for num_complex::Complex64
where
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ElectricCurrent> for Current<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ElectricCurrent> for Current<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ElectricCurrent> for Current<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ElectricCurrent> for Current<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Time<T>> for Current<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Charge<T>> for Current<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Conductance<T>> for Current<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Mul<Inductance<T>> for Current<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Mul<InverseCharge<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        Frequency {
            Hz: self.A.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseInductance<T>> for Current<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseInductance<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.A.clone() / rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Current<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseInductance {
            per_H: self.A.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for Current<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Energy {
            J: self.A.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for Current<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Conductance {
            S: self.A.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Power<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Power {
            W: self.A.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<MagneticFlux<T>> for Current<T>
where
    T: NumLike,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseInductance {
            per_H: self.A.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
...
impl<T> core::ops::Mul<Voltage<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Power<T>;
...
impl<T> core::ops::Div<Voltage<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
...
impl<T> core::ops::Div<Energy<T>> for Current<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Current<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for Current<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Current<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Current<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseTorque<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A.clone() * rhs.per_Nm,
        }
    }
}
/// Multiplying a Current by a InverseTorque returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A * rhs.per_Nm.clone(),
        }
    }
}
/// Multiplying a Current by a InverseTorque returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.A.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InversePower<T>> for Current<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePower<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.A.clone() * rhs.per_W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Power<T>> for Current<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Power<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.A.clone() / rhs.W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Current<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Current<T>) -> Self::Output {
        InverseCurrent {
            per_A: T::from(self.clone()) / rhs.A.clone(),
        }
    }
}
...
// 1/Current -> InverseCurrent
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
impl<T> core::ops::Div<Current<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseCurrent<T>;
...
// 1/Current -> InverseCurrent
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
impl<T> core::ops::Div<Current<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseCurrent<T>;
...
// 1/Current -> InverseCurrent
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
impl<T> core::ops::Div<Current<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseCurrent<T>;
...
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Current<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseCurrent<T>;
...
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Current<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseCurrent<T>;
...
/// Dividing a scalar value by a Current unit value returns a value of type InverseCurrent
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Current<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_au(au: T) -> Self {
        Distance {
            m: au * T::from(149597870700.0_f64),
        }
    }
    ...
    pub fn from_parsec(parsec: T) -> Self {
        Distance {
            m: parsec * T::from(3.08568047999355e+16_f64),
        }
    }
    ...
    pub fn from_lyr(lyr: T) -> Self {
        Distance {
            m: lyr * T::from(9460528169656200.0_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Length> for Distance<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Length> for Distance<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Length> for Distance<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Length> for Distance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Distance<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Area<T>;
...
impl<T> core::ops::Div<InverseDistance<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        Area {
            m2: self.m.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for Distance<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Mul<Area<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
...
impl<T> core::ops::Div<Area<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseDistance {
            per_m: self.m.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        Volume {
            m3: self.m.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVolume<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVolume<T>) -> Self::Output {
        InverseArea {
            per_m2: self.m.clone() * rhs.per_m3,
        }
    }
}
/// Multiplying a Distance by a InverseVolume returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        InverseArea {
            per_m2: self.m * rhs.per_m3.clone(),
        }
    }
}
/// Multiplying a Distance by a InverseVolume returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        InverseArea {
            per_m2: self.m.clone() * rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Volume<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        InverseArea {
            per_m2: self.m.clone() / rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaDensity<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaDensity<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m.clone() / rhs.kgpm2,
        }
    }
}
/// Dividing a Distance by a AreaDensity returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaDensity<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m / rhs.kgpm2.clone(),
        }
    }
}
/// Dividing a Distance by a AreaDensity returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaDensity<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m.clone() / rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaPerMass<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = VolumePerMass<T>;
    fn mul(self, rhs: AreaPerMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m * rhs.m2_per_kg,
        }
    }
}
/// Multiplying a Distance by a AreaPerMass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m.clone() * rhs.m2_per_kg,
        }
    }
}
/// Multiplying a Distance by a AreaPerMass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m * rhs.m2_per_kg.clone(),
        }
    }
}
/// Multiplying a Distance by a AreaPerMass returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.m.clone() * rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Density<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Density<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.m.clone() * rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Energy<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InverseForce {
            per_N: self.m.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InverseForce {
            per_N: self.m.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Force<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Mul<Frequency<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Velocity<T>;
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InverseForce {
            per_N: self.m.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseForce {
            per_N: self.m.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseForce<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Energy {
            J: self.m.clone() / rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<TimePerDistance<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Div<Velocity<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Div<VolumePerMass<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = AreaDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: VolumePerMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.m.clone() / rhs.m3_per_kg,
        }
    }
}
/// Dividing a Distance by a VolumePerMass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.m / rhs.m3_per_kg.clone(),
        }
    }
}
/// Dividing a Distance by a VolumePerMass returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.m.clone() / rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAbsorbedDose<T>> for Distance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.m.clone() * rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDoseEquivalent<T>> for Distance<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.m.clone() * rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Distance<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Distance<T>) -> Self::Output {
        InverseDistance {
            per_m: T::from(self.clone()) / rhs.m.clone(),
        }
    }
}
...
// 1/Distance -> InverseDistance
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
impl<T> core::ops::Div<Distance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseDistance<T>;
...
// 1/Distance -> InverseDistance
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
impl<T> core::ops::Div<Distance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseDistance<T>;
...
// 1/Distance -> InverseDistance
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
impl<T> core::ops::Div<Distance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseDistance<T>;
...
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Distance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseDistance<T>;
...
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Distance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseDistance<T>;
...
/// Dividing a scalar value by a Distance unit value returns a value of type InverseDistance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Distance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_mole(per_mole: T) -> Self {
        InverseAmount { per_mol: per_mole }
    }

    /// Returns a copy of this inverse amount value in inverse moles
    pub fn to_per_mole(&self) -> T {
        self.per_mol.clone()
    }
    ...
    pub fn from_per_mol(per_mol: T) -> Self {
        InverseAmount { per_mol: per_mol }
    }

    /// Returns a copy of this inverse amount value in inverse moles
    pub fn to_per_mol(&self) -> T {
        self.per_mol.clone()
    }
}

impl<T> fmt::Display for InverseAmount<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_count(per_count: T) -> Self {
        InverseAmount {
            per_mol: per_count * T::from(6.02e+23_f64),
        }
    }
    ...
    pub fn from_per_mmol(per_mmol: T) -> Self {
        InverseAmount {
            per_mol: per_mmol * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_umol(per_umol: T) -> Self {
        InverseAmount {
            per_mol: per_umol * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nmol(per_nmol: T) -> Self {
        InverseAmount {
            per_mol: per_nmol * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_pmol(per_pmol: T) -> Self {
        InverseAmount {
            per_mol: per_pmol * T::from(1000000000000.0_f64),
        }
    }
}
...
impl core::ops::Mul<InverseAmount<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: InverseAmount<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAmount {
            per_mol: self.clone() * rhs.per_mol,
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&InverseAmount<num_bigfloat::BigFloat>> for num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseAmount<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAmount {
            per_mol: self * rhs.per_mol.clone(),
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&InverseAmount<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseAmount<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAmount {
            per_mol: self.clone() * rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMass<T>> for InverseAmount<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol / rhs.per_kg,
        }
    }
}
/// Dividing a InverseAmount by a InverseMass returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol.clone() / rhs.per_kg,
        }
    }
}
/// Dividing a InverseAmount by a InverseMass returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol / rhs.per_kg.clone(),
        }
    }
}
/// Dividing a InverseAmount by a InverseMass returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol.clone() / rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Mass<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = MolarMass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Mass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol.clone() * rhs.kg,
        }
    }
}
/// Multiplying a InverseAmount by a Mass returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol * rhs.kg.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a Mass returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Mass<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.per_mol.clone() * rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseAmount<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Time<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol.clone() * rhs.s,
        }
    }
}
/// Multiplying a InverseAmount by a Time returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol * rhs.s.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a Time returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<CatalyticActivity<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: CatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol.clone() * rhs.molps,
        }
    }
}
/// Multiplying a InverseAmount by a CatalyticActivity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &CatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol * rhs.molps.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a CatalyticActivity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &CatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol.clone() * rhs.molps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Concentration<T>> for InverseAmount<T>
where
    T: NumLike,
{
    ...
    fn mul(self, rhs: Concentration<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol * rhs.molpm3,
        }
    }
}
/// Multiplying a InverseAmount by a Concentration returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Concentration<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol.clone() * rhs.molpm3,
        }
    }
}
/// Multiplying a InverseAmount by a Concentration returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Concentration<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol * rhs.molpm3.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a Concentration returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Concentration<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol.clone() * rhs.molpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCatalyticActivity<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseCatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol.clone() / rhs.s_per_mol,
        }
    }
}
/// Dividing a InverseAmount by a InverseCatalyticActivity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol / rhs.s_per_mol.clone(),
        }
    }
}
/// Dividing a InverseAmount by a InverseCatalyticActivity returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_mol.clone() / rhs.s_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Molality<T>> for InverseAmount<T>
where
    T: NumLike,
{
    ...
    fn mul(self, rhs: Molality<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol * rhs.molpkg,
        }
    }
}
/// Multiplying a InverseAmount by a Molality returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Molality<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol.clone() * rhs.molpkg,
        }
    }
}
/// Multiplying a InverseAmount by a Molality returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Molality<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol * rhs.molpkg.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a Molality returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Molality<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol.clone() * rhs.molpkg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MolarMass<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = InverseMass<T>;
    fn div(self, rhs: MolarMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol / rhs.kgpmol,
        }
    }
}
/// Dividing a InverseAmount by a MolarMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: MolarMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol.clone() / rhs.kgpmol,
        }
    }
}
/// Dividing a InverseAmount by a MolarMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol / rhs.kgpmol.clone(),
        }
    }
}
/// Dividing a InverseAmount by a MolarMass returns a value of type InverseMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarMass<T>) -> Self::Output {
        InverseMass {
            per_kg: self.per_mol.clone() / rhs.kgpmol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MolarVolume<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    fn div(self, rhs: MolarVolume<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol / rhs.m3_per_mol,
        }
    }
}
/// Dividing a InverseAmount by a MolarVolume returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: MolarVolume<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol.clone() / rhs.m3_per_mol,
        }
    }
}
/// Dividing a InverseAmount by a MolarVolume returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarVolume<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol / rhs.m3_per_mol.clone(),
        }
    }
}
/// Dividing a InverseAmount by a MolarVolume returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarVolume<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_mol.clone() / rhs.m3_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVolume<T>> for InverseAmount<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol / rhs.per_m3,
        }
    }
}
/// Dividing a InverseAmount by a InverseVolume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol.clone() / rhs.per_m3,
        }
    }
}
/// Dividing a InverseAmount by a InverseVolume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol / rhs.per_m3.clone(),
        }
    }
}
/// Dividing a InverseAmount by a InverseVolume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol.clone() / rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Volume<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = MolarVolume<T>;
    fn mul(self, rhs: Volume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol * rhs.m3,
        }
    }
}
/// Multiplying a InverseAmount by a Volume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Volume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol.clone() * rhs.m3,
        }
    }
}
/// Multiplying a InverseAmount by a Volume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol * rhs.m3.clone(),
        }
    }
}
/// Multiplying a InverseAmount by a Volume returns a value of type MolarVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        MolarVolume {
            m3_per_mol: self.per_mol.clone() * rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseAmount<T>
where
    T: NumLike,
{
    type Output = InverseCatalyticActivity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Frequency<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol.clone() / rhs.Hz,
        }
    }
}
/// Dividing a InverseAmount by a Frequency returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol / rhs.Hz.clone(),
        }
    }
}
/// Dividing a InverseAmount by a Frequency returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.per_mol.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAmount<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseAmount<T>) -> Self::Output {
        Amount {
            mol: T::from(self.clone()) / rhs.per_mol,
        }
    }
}
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Amount {
            mol: T::from(self) / rhs.per_mol.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Amount {
            mol: T::from(self.clone()) / rhs.per_mol.clone(),
        }
    }
}
...
// 1/InverseAmount -> Amount
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
impl<T> core::ops::Div<InverseAmount<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Amount<T>;
...
// 1/InverseAmount -> Amount
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
impl<T> core::ops::Div<InverseAmount<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Amount<T>;
...
// 1/InverseAmount -> Amount
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
impl<T> core::ops::Div<InverseAmount<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Amount<T>;
...
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseAmount<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Amount<T>;
...
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseAmount<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Amount<T>;
...
/// Dividing a scalar value by a InverseAmount unit value returns a value of type Amount
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseAmount<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_ampere(per_ampere: T) -> Self {
        InverseCurrent { per_A: per_ampere }
    }
...
impl<T> fmt::Display for InverseCurrent<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mA(per_mA: T) -> Self {
        InverseCurrent {
            per_A: per_mA * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uA(per_uA: T) -> Self {
        InverseCurrent {
            per_A: per_uA * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nA(per_nA: T) -> Self {
        InverseCurrent {
            per_A: per_nA * T::from(1000000000.0_f64),
        }
    }
...
impl core::ops::Mul<&InverseCurrent<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseCurrent<num_bigfloat::BigFloat>) -> Self::Output {
        InverseCurrent {
            per_A: self.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_A.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Charge<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Charge<T>) -> Self::Output {
        Time {
            s: self.per_A.clone() * rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Conductance<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Conductance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_A.clone() * rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Inductance<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Inductance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_A.clone() / rhs.H.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Time {
            s: self.per_A.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseInductance<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseInductance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_A.clone() * rhs.per_H,
        }
    }
}
/// Multiplying a InverseCurrent by a InverseInductance returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseInductance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_A * rhs.per_H.clone(),
        }
    }
}
/// Multiplying a InverseCurrent by a InverseInductance returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseInductance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_A.clone() * rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_A.clone() * rhs.per_Wb,
        }
    }
}
/// Multiplying a InverseCurrent by a InverseMagneticFlux returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_A * rhs.per_Wb.clone(),
        }
    }
}
/// Multiplying a InverseCurrent by a InverseMagneticFlux returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_A.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Inductance {
            H: self.per_A.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVoltage<T>) -> Self::Output {
        InversePower {
            per_W: self.per_A.clone() * rhs.per_V,
        }
    }
}
/// Multiplying a InverseCurrent by a InverseVoltage returns a value of type InversePower
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InversePower {
            per_W: self.per_A * rhs.per_V.clone(),
        }
    }
}
/// Multiplying a InverseCurrent by a InverseVoltage returns a value of type InversePower
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InversePower {
            per_W: self.per_A.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVoltage<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_A.clone() / rhs.per_V,
        }
    }
}
/// Dividing a InverseCurrent by a InverseVoltage returns a value of type Resistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_A / rhs.per_V.clone(),
        }
    }
}
/// Dividing a InverseCurrent by a InverseVoltage returns a value of type Resistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_A.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Inductance {
            H: self.per_A.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_A.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Resistance<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Resistance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_A.clone() / rhs.Ohm,
        }
    }
}
/// Dividing a InverseCurrent by a Resistance returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_A / rhs.Ohm.clone(),
        }
    }
}
/// Dividing a InverseCurrent by a Resistance returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_A.clone() / rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Voltage<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Voltage<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_A.clone() * rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Voltage<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Voltage<T>) -> Self::Output {
        InversePower {
            per_W: self.per_A.clone() / rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_A.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTorque<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A.clone() / rhs.per_Nm,
        }
    }
}
/// Dividing a InverseCurrent by a InverseTorque returns a value of type MagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A / rhs.per_Nm.clone(),
        }
    }
}
/// Dividing a InverseCurrent by a InverseTorque returns a value of type MagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.per_A.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePower<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePower<T>) -> Self::Output {
        Voltage {
            V: self.per_A.clone() / rhs.per_W.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Power<T>> for InverseCurrent<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Power<T>) -> Self::Output {
        Voltage {
            V: self.per_A.clone() * rhs.W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Current {
            A: T::from(self.clone()) / rhs.per_A.clone(),
        }
    }
}
...
// 1/InverseCurrent -> Current
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
impl<T> core::ops::Div<InverseCurrent<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Current<T>;
...
// 1/InverseCurrent -> Current
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
impl<T> core::ops::Div<InverseCurrent<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Current<T>;
...
// 1/InverseCurrent -> Current
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
impl<T> core::ops::Div<InverseCurrent<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Current<T>;
...
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseCurrent<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Current<T>;
...
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseCurrent<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Current<T>;
...
/// Dividing a scalar value by a InverseCurrent unit value returns a value of type Current
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseCurrent<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_m(per_m: T) -> Self {
        InverseDistance { per_m: per_m }
    }

    /// Returns a copy of this inverse distance value in inverse meters
    pub fn to_per_m(&self) -> T {
        self.per_m.clone()
    }
    ...
    pub fn from_per_meter(per_meter: T) -> Self {
        InverseDistance { per_m: per_meter }
    }

    /// Returns a copy of this inverse distance value in inverse meters
    pub fn to_per_meter(&self) -> T {
        self.per_m.clone()
    }
}

impl<T> fmt::Display for InverseDistance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mm(per_mm: T) -> Self {
        InverseDistance {
            per_m: per_mm * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_um(per_um: T) -> Self {
        InverseDistance {
            per_m: per_um * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nm(per_nm: T) -> Self {
        InverseDistance {
            per_m: per_nm * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_pm(per_pm: T) -> Self {
        InverseDistance {
            per_m: per_pm * T::from(1000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_au(per_au: T) -> Self {
        InverseDistance {
            per_m: per_au * T::from(6.68e-12_f64),
        }
    }
    ...
    pub fn from_per_parsec(per_parsec: T) -> Self {
        InverseDistance {
            per_m: per_parsec * T::from(3.24e-17_f64),
        }
    }
    ...
    pub fn from_per_lyr(per_lyr: T) -> Self {
        InverseDistance {
            per_m: per_lyr * T::from(1.06e-16_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseDistance<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseDistance<num_bigfloat::BigFloat>) -> Self::Output {
        InverseDistance {
            per_m: self.clone() * rhs.per_m.clone(),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::LinearNumberDensity> for InverseDistance<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::LinearNumberDensity {
        uom::si::f32::LinearNumberDensity::new::<uom::si::linear_number_density::per_meter>(
            self.per_m.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::LinearNumberDensity> for InverseDistance<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::LinearNumberDensity) -> Self {
        InverseDistance {
            per_m: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::LinearNumberDensity> for InverseDistance<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::LinearNumberDensity {
        uom::si::f64::LinearNumberDensity::new::<uom::si::linear_number_density::per_meter>(
            self.per_m.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::LinearNumberDensity> for InverseDistance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Distance<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Distance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m.clone() / rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDistance<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m.clone() * rhs.per_m,
        }
    }
}
/// Multiplying a InverseDistance by a InverseDistance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m * rhs.per_m.clone(),
        }
    }
}
/// Multiplying a InverseDistance by a InverseDistance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_m.clone() * rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseDistance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_m.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for InverseDistance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        Distance {
            m: self.per_m.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Area<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m.clone() / rhs.m2,
        }
    }
}
/// Dividing a InverseDistance by a Area returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m / rhs.m2.clone(),
        }
    }
}
/// Dividing a InverseDistance by a Area returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m.clone() * rhs.per_m2,
        }
    }
}
/// Multiplying a InverseDistance by a InverseArea returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m * rhs.per_m2.clone(),
        }
    }
}
/// Multiplying a InverseDistance by a InverseArea returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_m.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        Distance {
            m: self.per_m.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVolume<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        Area {
            m2: self.per_m.clone() / rhs.per_m3,
        }
    }
}
/// Dividing a InverseDistance by a InverseVolume returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Area {
            m2: self.per_m / rhs.per_m3.clone(),
        }
    }
}
/// Dividing a InverseDistance by a InverseVolume returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        Area {
            m2: self.per_m.clone() / rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Volume<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        Area {
            m2: self.per_m.clone() * rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaDensity<T>> for InverseDistance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaDensity<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m.clone() * rhs.kgpm2,
        }
    }
}
/// Multiplying a InverseDistance by a AreaDensity returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaDensity<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m * rhs.kgpm2.clone(),
        }
    }
}
/// Multiplying a InverseDistance by a AreaDensity returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaDensity<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m.clone() * rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerMass<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    fn div(self, rhs: AreaPerMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m / rhs.m2_per_kg,
        }
    }
}
/// Dividing a InverseDistance by a AreaPerMass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaPerMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m.clone() / rhs.m2_per_kg,
        }
    }
}
/// Dividing a InverseDistance by a AreaPerMass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m / rhs.m2_per_kg.clone(),
        }
    }
}
/// Dividing a InverseDistance by a AreaPerMass returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Density {
            kgpm3: self.per_m.clone() / rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Density<T>> for InverseDistance<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: Density<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m / rhs.kgpm3,
        }
    }
}
/// Dividing a InverseDistance by a Density returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Density<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m.clone() / rhs.kgpm3,
        }
    }
}
/// Dividing a InverseDistance by a Density returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m / rhs.kgpm3.clone(),
        }
    }
}
/// Dividing a InverseDistance by a Density returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m.clone() / rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Force {
            N: self.per_m.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Force {
            N: self.per_m.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Force<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Force<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m.clone() / rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_m.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Force {
            N: self.per_m.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Force {
            N: self.per_m.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseForce<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseForce<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m.clone() * rhs.per_N,
        }
    }
}
/// Multiplying a InverseDistance by a InverseForce returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseForce<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m * rhs.per_N.clone(),
        }
    }
}
/// Multiplying a InverseDistance by a InverseForce returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseForce<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_m.clone() * rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<TimePerDistance<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &TimePerDistance<T>) -> Self::Output {
        Frequency {
            Hz: self.per_m.clone() / rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Velocity<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Velocity<T>) -> Self::Output {
        Frequency {
            Hz: self.per_m.clone() * rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<VolumePerMass<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = AreaPerMass<T>;
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseDistance by a VolumePerMass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m.clone() * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseDistance by a VolumePerMass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m * rhs.m3_per_kg.clone(),
        }
    }
}
/// Multiplying a InverseDistance by a VolumePerMass returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_m.clone() * rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAbsorbedDose<T>> for InverseDistance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAbsorbedDose<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m.clone() / rhs.per_Gy,
        }
    }
}
/// Dividing a InverseDistance by a InverseAbsorbedDose returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m / rhs.per_Gy.clone(),
        }
    }
}
/// Dividing a InverseDistance by a InverseAbsorbedDose returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m.clone() / rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDoseEquivalent<T>> for InverseDistance<T>
where
    T: NumLike,
{
    type Output = Acceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDoseEquivalent<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m.clone() / rhs.per_Sv,
        }
    }
}
/// Dividing a InverseDistance by a InverseDoseEquivalent returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m / rhs.per_Sv.clone(),
        }
    }
}
/// Dividing a InverseDistance by a InverseDoseEquivalent returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_m.clone() / rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Distance<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        Distance {
            m: T::from(self.clone()) / rhs.per_m.clone(),
        }
    }
}
...
// 1/InverseDistance -> Distance
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
impl<T> core::ops::Div<InverseDistance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Distance<T>;
...
// 1/InverseDistance -> Distance
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
impl<T> core::ops::Div<InverseDistance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Distance<T>;
...
// 1/InverseDistance -> Distance
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
impl<T> core::ops::Div<InverseDistance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Distance<T>;
...
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseDistance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Distance<T>;
...
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseDistance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Distance<T>;
...
/// Dividing a scalar value by a InverseDistance unit value returns a value of type Distance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseDistance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Distance<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_cd(per_cd: T) -> Self {
        InverseLuminosity { per_cd: per_cd }
    }
...
impl<T> fmt::Display for InverseLuminosity<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mcd(per_mcd: T) -> Self {
        InverseLuminosity {
            per_cd: per_mcd * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_ucd(per_ucd: T) -> Self {
        InverseLuminosity {
            per_cd: per_ucd * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_ncd(per_ncd: T) -> Self {
        InverseLuminosity {
            per_cd: per_ncd * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_kcd(per_kcd: T) -> Self {
        InverseLuminosity {
            per_cd: per_kcd * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_Mcd(per_Mcd: T) -> Self {
        InverseLuminosity {
            per_cd: per_Mcd * T::from(1e-06_f64),
        }
    }
    ...
    pub fn from_per_Gcd(per_Gcd: T) -> Self {
        InverseLuminosity {
            per_cd: per_Gcd * T::from(1e-09_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseLuminosity<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseLuminosity<num_bigfloat::BigFloat>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.clone() * rhs.per_cd.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminousFlux<T>> for InverseLuminosity<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        SolidAngle {
            sr: self.per_cd.clone() / rhs.per_lm,
        }
    }
}
/// Dividing a InverseLuminosity by a InverseLuminousFlux returns a value of type SolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        SolidAngle {
            sr: self.per_cd / rhs.per_lm.clone(),
        }
    }
}
/// Dividing a InverseLuminosity by a InverseLuminousFlux returns a value of type SolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        SolidAngle {
            sr: self.per_cd.clone() / rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<LuminousFlux<T>> for InverseLuminosity<T>
where
    T: NumLike,
{
    type Output = SolidAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &LuminousFlux<T>) -> Self::Output {
        SolidAngle {
            sr: self.per_cd.clone() * rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseSolidAngle<T>> for InverseLuminosity<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseSolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd.clone() * rhs.per_sr,
        }
    }
}
/// Multiplying a InverseLuminosity by a InverseSolidAngle returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd * rhs.per_sr.clone(),
        }
    }
}
/// Multiplying a InverseLuminosity by a InverseSolidAngle returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd.clone() * rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<SolidAngle<T>> for InverseLuminosity<T>
where
    T: NumLike,
{
    type Output = InverseLuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: SolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd.clone() / rhs.sr,
        }
    }
}
/// Dividing a InverseLuminosity by a SolidAngle returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd / rhs.sr.clone(),
        }
    }
}
/// Dividing a InverseLuminosity by a SolidAngle returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.per_cd.clone() / rhs.sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminosity<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseLuminosity<T>) -> Self::Output {
        Luminosity {
            cd: T::from(self.clone()) / rhs.per_cd,
        }
    }
}
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        Luminosity {
            cd: T::from(self) / rhs.per_cd.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        Luminosity {
            cd: T::from(self.clone()) / rhs.per_cd.clone(),
        }
    }
}
...
// 1/InverseLuminosity -> Luminosity
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
impl<T> core::ops::Div<InverseLuminosity<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Luminosity<T>;
...
// 1/InverseLuminosity -> Luminosity
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
impl<T> core::ops::Div<InverseLuminosity<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Luminosity<T>;
...
// 1/InverseLuminosity -> Luminosity
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
impl<T> core::ops::Div<InverseLuminosity<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Luminosity<T>;
...
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseLuminosity<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Luminosity<T>;
...
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseLuminosity<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Luminosity<T>;
...
/// Dividing a scalar value by a InverseLuminosity unit value returns a value of type Luminosity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseLuminosity<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Luminosity<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_kg(per_kg: T) -> Self {
        InverseMass { per_kg: per_kg }
    }

    /// Returns a copy of this inverse mass value in inverse kilograms
    pub fn to_per_kg(&self) -> T {
        self.per_kg.clone()
    }
    ...
    pub fn from_per_kilograms(per_kilograms: T) -> Self {
        InverseMass {
            per_kg: per_kilograms,
        }
    }

    /// Returns a copy of this inverse mass value in inverse kilograms
    pub fn to_per_kilograms(&self) -> T {
        self.per_kg.clone()
    }
}

impl<T> fmt::Display for InverseMass<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_g(per_g: T) -> Self {
        InverseMass {
            per_kg: per_g * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_mg(per_mg: T) -> Self {
        InverseMass {
            per_kg: per_mg * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_ug(per_ug: T) -> Self {
        InverseMass {
            per_kg: per_ug * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_ng(per_ng: T) -> Self {
        InverseMass {
            per_kg: per_ng * T::from(1000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_pg(per_pg: T) -> Self {
        InverseMass {
            per_kg: per_pg * T::from(1000000000000000.0_f64),
        }
    }
    ...
    pub fn from_per_tons(per_tons: T) -> Self {
        InverseMass {
            per_kg: per_tons * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_earth_mass(per_earth_mass: T) -> Self {
        InverseMass {
            per_kg: per_earth_mass * T::from(1.6699999999999999e-25_f64),
        }
    }
    ...
    pub fn from_per_jupiter_mass(per_jupiter_mass: T) -> Self {
        InverseMass {
            per_kg: per_jupiter_mass * T::from(5.27e-28_f64),
        }
    }
    ...
    pub fn from_per_solar_mass(per_solar_mass: T) -> Self {
        InverseMass {
            per_kg: per_solar_mass * T::from(5.03e-31_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseMass<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseMass<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMass {
            per_kg: self.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Amount<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Molality<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Amount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg.clone() * rhs.mol,
        }
    }
}
/// Multiplying a InverseMass by a Amount returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Amount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg * rhs.mol.clone(),
        }
    }
}
/// Multiplying a InverseMass by a Amount returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Amount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg.clone() * rhs.mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAmount<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Molality<T>;
    fn div(self, rhs: InverseAmount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg / rhs.per_mol,
        }
    }
}
/// Dividing a InverseMass by a InverseAmount returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAmount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg.clone() / rhs.per_mol,
        }
    }
}
/// Dividing a InverseMass by a InverseAmount returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg / rhs.per_mol.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseAmount returns a value of type Molality
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAmount<T>) -> Self::Output {
        Molality {
            molpkg: self.per_kg.clone() / rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Molality<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseAmount<T>;
    fn div(self, rhs: Molality<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg / rhs.molpkg,
        }
    }
}
/// Dividing a InverseMass by a Molality returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Molality<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg.clone() / rhs.molpkg,
        }
    }
}
/// Dividing a InverseMass by a Molality returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Molality<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg / rhs.molpkg.clone(),
        }
    }
}
/// Dividing a InverseMass by a Molality returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Molality<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg.clone() / rhs.molpkg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MolarMass<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseAmount<T>;
    fn mul(self, rhs: MolarMass<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg * rhs.kgpmol,
        }
    }
}
/// Multiplying a InverseMass by a MolarMass returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: MolarMass<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg.clone() * rhs.kgpmol,
        }
    }
}
/// Multiplying a InverseMass by a MolarMass returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarMass<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg * rhs.kgpmol.clone(),
        }
    }
}
/// Multiplying a InverseMass by a MolarMass returns a value of type InverseAmount
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MolarMass<T>) -> Self::Output {
        InverseAmount {
            per_mol: self.per_kg.clone() * rhs.kgpmol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = AreaPerMass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Area<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg.clone() * rhs.m2,
        }
    }
}
/// Multiplying a InverseMass by a Area returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg * rhs.m2.clone(),
        }
    }
}
/// Multiplying a InverseMass by a Area returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = AreaPerMass<T>;
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg / rhs.per_m2,
        }
    }
}
/// Dividing a InverseMass by a InverseArea returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg.clone() / rhs.per_m2,
        }
    }
}
/// Dividing a InverseMass by a InverseArea returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg / rhs.per_m2.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseArea returns a value of type AreaPerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaPerMass {
            m2_per_kg: self.per_kg.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVolume<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = VolumePerMass<T>;
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg / rhs.per_m3,
        }
    }
}
/// Dividing a InverseMass by a InverseVolume returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVolume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg.clone() / rhs.per_m3,
        }
    }
}
/// Dividing a InverseMass by a InverseVolume returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg / rhs.per_m3.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseVolume returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVolume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg.clone() / rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Volume<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = VolumePerMass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Volume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg.clone() * rhs.m3,
        }
    }
}
/// Multiplying a InverseMass by a Volume returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg * rhs.m3.clone(),
        }
    }
}
/// Multiplying a InverseMass by a Volume returns a value of type VolumePerMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Volume<T>) -> Self::Output {
        VolumePerMass {
            m3_per_kg: self.per_kg.clone() * rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Acceleration<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Acceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg.clone() / rhs.mps2,
        }
    }
}
/// Dividing a InverseMass by a Acceleration returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg / rhs.mps2.clone(),
        }
    }
}
/// Dividing a InverseMass by a Acceleration returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg.clone() / rhs.mps2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaDensity<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg.clone() * rhs.kgpm2,
        }
    }
}
/// Multiplying a InverseMass by a AreaDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg * rhs.kgpm2.clone(),
        }
    }
}
/// Multiplying a InverseMass by a AreaDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg.clone() * rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerMass<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    fn div(self, rhs: AreaPerMass<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg / rhs.m2_per_kg,
        }
    }
}
/// Dividing a InverseMass by a AreaPerMass returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaPerMass<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg.clone() / rhs.m2_per_kg,
        }
    }
}
/// Dividing a InverseMass by a AreaPerMass returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg / rhs.m2_per_kg.clone(),
        }
    }
}
/// Dividing a InverseMass by a AreaPerMass returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerMass<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_kg.clone() / rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Density<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Density<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg.clone() * rhs.kgpm3,
        }
    }
}
/// Multiplying a InverseMass by a Density returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Density<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg * rhs.kgpm3.clone(),
        }
    }
}
/// Multiplying a InverseMass by a Density returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Density<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg.clone() * rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Force<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Acceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Force<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_kg.clone() * rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAcceleration<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAcceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg.clone() * rhs.s2pm,
        }
    }
}
/// Multiplying a InverseMass by a InverseAcceleration returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg * rhs.s2pm.clone(),
        }
    }
}
/// Multiplying a InverseMass by a InverseAcceleration returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseForce {
            per_N: self.per_kg.clone() * rhs.s2pm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseForce<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Acceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseForce<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_kg.clone() / rhs.per_N,
        }
    }
}
/// Dividing a InverseMass by a InverseForce returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_kg / rhs.per_N.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseForce returns a value of type Acceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Acceleration {
            mps2: self.per_kg.clone() / rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMomentOfInertia<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMomentOfInertia<T>) -> Self::Output {
        Area {
            m2: self.per_kg.clone() / rhs.per_kgm2,
        }
    }
}
/// Dividing a InverseMass by a InverseMomentOfInertia returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        Area {
            m2: self.per_kg / rhs.per_kgm2.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseMomentOfInertia returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        Area {
            m2: self.per_kg.clone() / rhs.per_kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMomentum<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Velocity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMomentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg.clone() / rhs.s_per_kgm,
        }
    }
}
/// Dividing a InverseMass by a InverseMomentum returns a value of type Velocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg / rhs.s_per_kgm.clone(),
        }
    }
}
/// Dividing a InverseMass by a InverseMomentum returns a value of type Velocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMomentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg.clone() / rhs.s_per_kgm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MomentOfInertia<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MomentOfInertia<T>) -> Self::Output {
        Area {
            m2: self.per_kg.clone() * rhs.kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Momentum<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = Velocity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Momentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg.clone() * rhs.kgmps,
        }
    }
}
/// Multiplying a InverseMass by a Momentum returns a value of type Velocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Momentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg * rhs.kgmps.clone(),
        }
    }
}
/// Multiplying a InverseMass by a Momentum returns a value of type Velocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Momentum<T>) -> Self::Output {
        Velocity {
            mps: self.per_kg.clone() * rhs.kgmps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<TimePerDistance<T>> for InverseMass<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: TimePerDistance<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg.clone() * rhs.spm,
        }
    }
}
/// Multiplying a InverseMass by a TimePerDistance returns a value of type InverseMomentum
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &TimePerDistance<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg * rhs.spm.clone(),
        }
    }
}
/// Multiplying a InverseMass by a TimePerDistance returns a value of type InverseMomentum
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &TimePerDistance<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg.clone() * rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Velocity<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseMomentum<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Velocity<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg.clone() / rhs.mps,
        }
    }
}
/// Dividing a InverseMass by a Velocity returns a value of type InverseMomentum
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Velocity<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg / rhs.mps.clone(),
        }
    }
}
/// Dividing a InverseMass by a Velocity returns a value of type InverseMomentum
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Velocity<T>) -> Self::Output {
        InverseMomentum {
            s_per_kgm: self.per_kg.clone() / rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<VolumePerMass<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseVolume<T>;
    fn div(self, rhs: VolumePerMass<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg / rhs.m3_per_kg,
        }
    }
}
/// Dividing a InverseMass by a VolumePerMass returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: VolumePerMass<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg.clone() / rhs.m3_per_kg,
        }
    }
}
/// Dividing a InverseMass by a VolumePerMass returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg / rhs.m3_per_kg.clone(),
        }
    }
}
/// Dividing a InverseMass by a VolumePerMass returns a value of type InverseVolume
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InverseVolume {
            per_m3: self.per_kg.clone() / rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAbsorbedDose<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAbsorbedDose<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg.clone() * rhs.per_Gy,
        }
    }
}
/// Multiplying a InverseMass by a InverseAbsorbedDose returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg * rhs.per_Gy.clone(),
        }
    }
}
/// Multiplying a InverseMass by a InverseAbsorbedDose returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg.clone() * rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDoseEquivalent<T>> for InverseMass<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseDoseEquivalent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg.clone() * rhs.per_Sv,
        }
    }
}
/// Multiplying a InverseMass by a InverseDoseEquivalent returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg * rhs.per_Sv.clone(),
        }
    }
}
/// Multiplying a InverseMass by a InverseDoseEquivalent returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_kg.clone() * rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMass<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Mass<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseMass<T>) -> Self::Output {
        Mass {
            kg: T::from(self.clone()) / rhs.per_kg,
        }
    }
}
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        Mass {
            kg: T::from(self) / rhs.per_kg.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMass<T>) -> Self::Output {
        Mass {
            kg: T::from(self.clone()) / rhs.per_kg.clone(),
        }
    }
}
...
// 1/InverseMass -> Mass
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
impl<T> core::ops::Div<InverseMass<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Mass<T>;
...
// 1/InverseMass -> Mass
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
impl<T> core::ops::Div<InverseMass<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Mass<T>;
...
// 1/InverseMass -> Mass
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
impl<T> core::ops::Div<InverseMass<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Mass<T>;
...
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseMass<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Mass<T>;
...
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMass<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Mass<T>;
...
/// Dividing a scalar value by a InverseMass unit value returns a value of type Mass
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMass<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_K(per_K: T) -> Self {
        InverseTemperature { per_K: per_K }
    }

    /// Returns a copy of this inverse temperature value in inverse degrees kelvin
    pub fn to_per_K(&self) -> T {
        self.per_K.clone()
    }
}

impl<T> fmt::Display for InverseTemperature<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl core::ops::Mul<&InverseTemperature<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseTemperature<num_bigfloat::BigFloat>) -> Self::Output {
        InverseTemperature {
            per_K: self.clone() * rhs.per_K.clone(),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::TemperatureCoefficient> for InverseTemperature<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::TemperatureCoefficient {
        uom::si::f32::TemperatureCoefficient::new::<uom::si::temperature_coefficient::per_kelvin>(
            self.per_K.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::TemperatureCoefficient> for InverseTemperature<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::TemperatureCoefficient) -> Self {
        InverseTemperature {
            per_K: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::TemperatureCoefficient> for InverseTemperature<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::TemperatureCoefficient {
        uom::si::f64::TemperatureCoefficient::new::<uom::si::temperature_coefficient::per_kelvin>(
            self.per_K.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::TemperatureCoefficient> for InverseTemperature<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<InverseAbsorbedDose<T>> for InverseTemperature<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAbsorbedDose<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K / rhs.per_Gy,
        }
    }
}
/// Dividing a InverseTemperature by a InverseAbsorbedDose returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAbsorbedDose<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K.clone() / rhs.per_Gy,
        }
    }
}
/// Dividing a InverseTemperature by a InverseAbsorbedDose returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K / rhs.per_Gy.clone(),
        }
    }
}
/// Dividing a InverseTemperature by a InverseAbsorbedDose returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K.clone() / rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDoseEquivalent<T>> for InverseTemperature<T>
where
    T: NumLike,
{
    type Output = SpecificHeatCapacity<T>;
    fn div(self, rhs: InverseDoseEquivalent<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K / rhs.per_Sv,
        }
    }
}
/// Dividing a InverseTemperature by a InverseDoseEquivalent returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDoseEquivalent<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K.clone() / rhs.per_Sv,
        }
    }
}
/// Dividing a InverseTemperature by a InverseDoseEquivalent returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K / rhs.per_Sv.clone(),
        }
    }
}
/// Dividing a InverseTemperature by a InverseDoseEquivalent returns a value of type SpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        SpecificHeatCapacity {
            J_per_kgK: self.per_K.clone() / rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTemperature<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseTemperature<T>) -> Self::Output {
        Temperature {
            K: T::from(self.clone()) / rhs.per_K.clone(),
        }
    }
}
...
// 1/InverseTemperature -> Temperature
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
impl<T> core::ops::Div<InverseTemperature<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Temperature<T>;
...
// 1/InverseTemperature -> Temperature
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
impl<T> core::ops::Div<InverseTemperature<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Temperature<T>;
...
// 1/InverseTemperature -> Temperature
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
impl<T> core::ops::Div<InverseTemperature<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Temperature<T>;
...
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseTemperature<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Temperature<T>;
...
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseTemperature<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Temperature<T>;
...
/// Dividing a scalar value by a InverseTemperature unit value returns a value of type Temperature
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseTemperature<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Temperature<T>;
...
impl<T> fmt::Display for Luminosity<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_Gcd(Gcd: T) -> Self {
        Luminosity {
            cd: Gcd * T::from(1000000000.0_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::LuminousIntensity> for Luminosity<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::LuminousIntensity> for Luminosity<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::LuminousIntensity> for Luminosity<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::LuminousIntensity> for Luminosity<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<InverseLuminousFlux<T>> for Luminosity<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.cd.clone() * rhs.per_lm,
        }
    }
}
/// Multiplying a Luminosity by a InverseLuminousFlux returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.cd * rhs.per_lm.clone(),
        }
    }
}
/// Multiplying a Luminosity by a InverseLuminousFlux returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.cd.clone() * rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<LuminousFlux<T>> for Luminosity<T>
where
    T: NumLike,
{
    type Output = InverseSolidAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.cd.clone() / rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSolidAngle<T>> for Luminosity<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        LuminousFlux {
            lm: self.cd.clone() / rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<SolidAngle<T>> for Luminosity<T>
where
    T: NumLike,
{
    type Output = LuminousFlux<T>;
...
impl<T> core::ops::Div<Luminosity<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Luminosity<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: T::from(self.clone()) / rhs.cd,
        }
    }
}
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: T::from(self) / rhs.cd.clone(),
        }
    }
}
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: T::from(self.clone()) / rhs.cd.clone(),
        }
    }
}
...
// 1/Luminosity -> InverseLuminosity
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
impl<T> core::ops::Div<Luminosity<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseLuminosity<T>;
...
// 1/Luminosity -> InverseLuminosity
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
impl<T> core::ops::Div<Luminosity<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseLuminosity<T>;
...
// 1/Luminosity -> InverseLuminosity
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
impl<T> core::ops::Div<Luminosity<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseLuminosity<T>;
...
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Luminosity<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseLuminosity<T>;
...
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Luminosity<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseLuminosity<T>;
...
/// Dividing a scalar value by a Luminosity unit value returns a value of type InverseLuminosity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Luminosity<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseLuminosity<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_earth_mass(earth_mass: T) -> Self {
        Mass {
            kg: earth_mass * T::from(5.9722e+24_f64),
        }
    }
    ...
    pub fn from_jupiter_mass(jupiter_mass: T) -> Self {
        Mass {
            kg: jupiter_mass * T::from(1.8986e+27_f64),
        }
    }
    ...
    pub fn from_solar_mass(solar_mass: T) -> Self {
        Mass {
            kg: solar_mass * T::from(1.9885500000000002e+30_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Mass> for Mass<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Mass> for Mass<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Mass> for Mass<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Mass> for Mass<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Amount<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = MolarMass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.kg.clone() / rhs.mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAmount<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = MolarMass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAmount<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.kg.clone() * rhs.per_mol,
        }
    }
}
/// Multiplying a Mass by a InverseAmount returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.kg * rhs.per_mol.clone(),
        }
    }
}
/// Multiplying a Mass by a InverseAmount returns a value of type MolarMass
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        MolarMass {
            kgpmol: self.kg.clone() * rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Molality<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Molality<T>) -> Self::Output {
        Amount {
            mol: self.kg.clone() * rhs.molpkg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MolarMass<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MolarMass<T>) -> Self::Output {
        Amount {
            mol: self.kg.clone() / rhs.kgpmol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = AreaDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.kg.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = AreaDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.kg.clone() * rhs.per_m2,
        }
    }
}
/// Multiplying a Mass by a InverseArea returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.kg * rhs.per_m2.clone(),
        }
    }
}
/// Multiplying a Mass by a InverseArea returns a value of type AreaDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaDensity {
            kgpm2: self.kg.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVolume<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVolume<T>) -> Self::Output {
        Density {
            kgpm3: self.kg.clone() * rhs.per_m3,
        }
    }
}
/// Multiplying a Mass by a InverseVolume returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        Density {
            kgpm3: self.kg * rhs.per_m3.clone(),
        }
    }
}
/// Multiplying a Mass by a InverseVolume returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVolume<T>) -> Self::Output {
        Density {
            kgpm3: self.kg.clone() * rhs.per_m3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Volume<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Volume<T>) -> Self::Output {
        Density {
            kgpm3: self.kg.clone() / rhs.m3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Acceleration<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        Force {
            N: self.kg.clone() * rhs.mps2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaDensity<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaDensity<T>) -> Self::Output {
        Area {
            m2: self.kg.clone() / rhs.kgpm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AreaPerMass<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerMass<T>) -> Self::Output {
        Area {
            m2: self.kg.clone() * rhs.m2_per_kg,
        }
    }
}
/// Multiplying a Mass by a AreaPerMass returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Area {
            m2: self.kg * rhs.m2_per_kg.clone(),
        }
    }
}
/// Multiplying a Mass by a AreaPerMass returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerMass<T>) -> Self::Output {
        Area {
            m2: self.kg.clone() * rhs.m2_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Density<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        Volume {
            m3: self.kg.clone() / rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Force<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Force<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.kg.clone() / rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAcceleration<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Force<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        Force {
            N: self.kg.clone() / rhs.s2pm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseForce<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseForce<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.kg.clone() * rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMomentOfInertia<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMomentOfInertia<T>) -> Self::Output {
        InverseArea {
            per_m2: self.kg.clone() * rhs.per_kgm2,
        }
    }
}
/// Multiplying a Mass by a InverseMomentOfInertia returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        InverseArea {
            per_m2: self.kg * rhs.per_kgm2.clone(),
        }
    }
}
/// Multiplying a Mass by a InverseMomentOfInertia returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentOfInertia<T>) -> Self::Output {
        InverseArea {
            per_m2: self.kg.clone() * rhs.per_kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMomentum<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMomentum<T>) -> Self::Output {
        TimePerDistance {
            spm: self.kg.clone() * rhs.s_per_kgm,
        }
    }
}
/// Multiplying a Mass by a InverseMomentum returns a value of type TimePerDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentum<T>) -> Self::Output {
        TimePerDistance {
            spm: self.kg * rhs.s_per_kgm.clone(),
        }
    }
}
/// Multiplying a Mass by a InverseMomentum returns a value of type TimePerDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentum<T>) -> Self::Output {
        TimePerDistance {
            spm: self.kg.clone() * rhs.s_per_kgm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MomentOfInertia<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MomentOfInertia<T>) -> Self::Output {
        InverseArea {
            per_m2: self.kg.clone() / rhs.kgm2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Momentum<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Momentum<T>) -> Self::Output {
        TimePerDistance {
            spm: self.kg.clone() / rhs.kgmps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<TimePerDistance<T>> for Mass<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &TimePerDistance<T>) -> Self::Output {
        Momentum {
            kgmps: self.kg.clone() / rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Velocity<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Momentum<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Velocity<T>) -> Self::Output {
        Momentum {
            kgmps: self.kg.clone() * rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<VolumePerMass<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Volume<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        Volume {
            m3: self.kg.clone() * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a Mass by a VolumePerMass returns a value of type Volume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        Volume {
            m3: self.kg * rhs.m3_per_kg.clone(),
        }
    }
}
/// Multiplying a Mass by a VolumePerMass returns a value of type Volume
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        Volume {
            m3: self.kg.clone() * rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AbsorbedDose<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Mul<DoseEquivalent<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<InverseAbsorbedDose<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        Energy {
            J: self.kg.clone() / rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDoseEquivalent<T>> for Mass<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        Energy {
            J: self.kg.clone() / rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseMass<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Mass<T>) -> Self::Output {
        InverseMass {
            per_kg: T::from(self.clone()) / rhs.kg,
        }
    }
}
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseMass {
            per_kg: T::from(self) / rhs.kg.clone(),
        }
    }
}
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseMass {
            per_kg: T::from(self.clone()) / rhs.kg.clone(),
        }
    }
}
...
// 1/Mass -> InverseMass
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
impl<T> core::ops::Div<Mass<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseMass<T>;
...
// 1/Mass -> InverseMass
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
impl<T> core::ops::Div<Mass<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseMass<T>;
...
// 1/Mass -> InverseMass
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
impl<T> core::ops::Div<Mass<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseMass<T>;
...
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Mass<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseMass<T>;
...
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Mass<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseMass<T>;
...
/// Dividing a scalar value by a Mass unit value returns a value of type InverseMass
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Mass<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseMass<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_C(C: T) -> Self {
        Temperature {
            K: (C + T::from(273.15_f64)) * T::from(1.0_f64),
        }
    }
    ...
    pub fn from_celsius(celsius: T) -> Self {
        Temperature {
            K: (celsius + T::from(273.15_f64)) * T::from(1.0_f64),
        }
    }
    ...
    pub fn from_F(F: T) -> Self {
        Temperature {
            K: (F + T::from(459.67_f64)) * T::from(0.555555555555556_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ThermodynamicTemperature> for Temperature<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::ThermodynamicTemperature {
        uom::si::f32::ThermodynamicTemperature::new::<uom::si::thermodynamic_temperature::kelvin>(
            self.K.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ThermodynamicTemperature> for Temperature<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ThermodynamicTemperature> for Temperature<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::ThermodynamicTemperature {
        uom::si::f64::ThermodynamicTemperature::new::<uom::si::thermodynamic_temperature::kelvin>(
            self.K.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ThermodynamicTemperature> for Temperature<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<InverseAbsorbedDose<T>> for Temperature<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAbsorbedDose<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K.clone() * rhs.per_Gy,
        }
    }
}
/// Multiplying a Temperature by a InverseAbsorbedDose returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K * rhs.per_Gy.clone(),
        }
    }
}
/// Multiplying a Temperature by a InverseAbsorbedDose returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K.clone() * rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDoseEquivalent<T>> for Temperature<T>
where
    T: NumLike,
{
    type Output = InverseSpecificHeatCapacity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseDoseEquivalent<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K.clone() * rhs.per_Sv,
        }
    }
}
/// Multiplying a Temperature by a InverseDoseEquivalent returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K * rhs.per_Sv.clone(),
        }
    }
}
/// Multiplying a Temperature by a InverseDoseEquivalent returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.K.clone() * rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Temperature<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Temperature<T>) -> Self::Output {
        InverseTemperature {
            per_K: T::from(self.clone()) / rhs.K.clone(),
        }
    }
}
...
// 1/Temperature -> InverseTemperature
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
impl<T> core::ops::Div<Temperature<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseTemperature<T>;
...
// 1/Temperature -> InverseTemperature
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
impl<T> core::ops::Div<Temperature<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseTemperature<T>;
...
// 1/Temperature -> InverseTemperature
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
impl<T> core::ops::Div<Temperature<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseTemperature<T>;
...
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Temperature<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseTemperature<T>;
...
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Temperature<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseTemperature<T>;
...
/// Dividing a scalar value by a Temperature unit value returns a value of type InverseTemperature
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Temperature<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseTemperature<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_yr(yr: T) -> Self {
        Time {
            s: yr * T::from(31556925.19008_f64),
        }
    }
    ...
    pub fn from_kyr(kyr: T) -> Self {
        Time {
            s: kyr * T::from(31556925190.08_f64),
        }
    }
    ...
    pub fn from_Myr(Myr: T) -> Self {
        Time {
            s: Myr * T::from(31556925190080.0_f64),
        }
    }
    ...
    pub fn from_Gyr(Gyr: T) -> Self {
        Time {
            s: Gyr * T::from(3.155692519008e+16_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Time> for Time<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Time> for Time<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Time> for Time<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Time> for Time<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Amount<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseCatalyticActivity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Amount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s.clone() / rhs.mol,
        }
    }
}
/// Dividing a Time by a Amount returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s / rhs.mol.clone(),
        }
    }
}
/// Dividing a Time by a Amount returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Amount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s.clone() / rhs.mol.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Current<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Div<Distance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
...
impl<T> core::ops::Mul<InverseAmount<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseCatalyticActivity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAmount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s.clone() * rhs.per_mol,
        }
    }
}
/// Multiplying a Time by a InverseAmount returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s * rhs.per_mol.clone(),
        }
    }
}
/// Multiplying a Time by a InverseAmount returns a value of type InverseCatalyticActivity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAmount<T>) -> Self::Output {
        InverseCatalyticActivity {
            s_per_mol: self.s.clone() * rhs.per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Charge {
            C: self.s.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseDistance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseDistance<T>) -> Self::Output {
        TimePerDistance {
            spm: self.s.clone() * rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<CatalyticActivity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &CatalyticActivity<T>) -> Self::Output {
        Amount {
            mol: self.s.clone() * rhs.molps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCatalyticActivity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Amount<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseCatalyticActivity<T>) -> Self::Output {
        Amount {
            mol: self.s.clone() / rhs.s_per_mol,
        }
    }
}
/// Dividing a Time by a InverseCatalyticActivity returns a value of type Amount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Amount {
            mol: self.s / rhs.s_per_mol.clone(),
        }
    }
}
/// Dividing a Time by a InverseCatalyticActivity returns a value of type Amount
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCatalyticActivity<T>) -> Self::Output {
        Amount {
            mol: self.s.clone() / rhs.s_per_mol.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Capacitance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
...
impl<T> core::ops::Div<Charge<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.s.clone() / rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Conductance<T>> for Time<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Conductance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
...
impl<T> core::ops::Mul<Elastance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Elastance<T>) -> Self::Output {
        Resistance {
            Ohm: self.s.clone() * rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Inductance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
...
impl<T> core::ops::Mul<InverseCharge<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.s.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseInductance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.s.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for Time<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.s.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.s.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
...
impl<T> core::ops::Div<Resistance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
...
impl<T> core::ops::Mul<Voltage<T>> for Time<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Div<Angle<T>> for Time<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Angle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s.clone() / rhs.rad,
        }
    }
}
/// Dividing a Time by a Angle returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s / rhs.rad.clone(),
        }
    }
}
/// Dividing a Time by a Angle returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Angle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s.clone() / rhs.rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAngle<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseAngularVelocity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAngle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s.clone() * rhs.per_rad,
        }
    }
}
/// Multiplying a Time by a InverseAngle returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s * rhs.per_rad.clone(),
        }
    }
}
/// Multiplying a Time by a InverseAngle returns a value of type InverseAngularVelocity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngle<T>) -> Self::Output {
        InverseAngularVelocity {
            s_per_rad: self.s.clone() * rhs.per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Acceleration<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Velocity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        Velocity {
            mps: self.s.clone() * rhs.mps2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AngularAcceleration<T>> for Time<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AngularAcceleration<T>) -> Self::Output {
        AngularVelocity {
            radps: self.s.clone() * rhs.radps2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<AngularVelocity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AngularVelocity<T>) -> Self::Output {
        Angle {
            rad: self.s.clone() * rhs.radps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AngularVelocity<T>> for Time<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AngularVelocity<T>) -> Self::Output {
        InverseAngularAcceleration {
            s2prad: self.s.clone() / rhs.radps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Energy<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InversePower {
            per_W: self.s.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InversePower {
            per_W: self.s.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Force<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Momentum<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Force<T>) -> Self::Output {
        Momentum {
            kgmps: self.s.clone() * rhs.N.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAcceleration<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Velocity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        Velocity {
            mps: self.s.clone() / rhs.s2pm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngularAcceleration<T>> for Time<T>
where
    T: NumLike,
{
    type Output = AngularVelocity<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngularAcceleration<T>) -> Self::Output {
        AngularVelocity {
            radps: self.s.clone() / rhs.s2prad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseAngularVelocity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseAngularAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseAngularVelocity<T>) -> Self::Output {
        InverseAngularAcceleration {
            s2prad: self.s.clone() * rhs.s_per_rad,
        }
    }
}
/// Multiplying a Time by a InverseAngularVelocity returns a value of type InverseAngularAcceleration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        InverseAngularAcceleration {
            s2prad: self.s * rhs.s_per_rad.clone(),
        }
    }
}
/// Multiplying a Time by a InverseAngularVelocity returns a value of type InverseAngularAcceleration
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        InverseAngularAcceleration {
            s2prad: self.s.clone() * rhs.s_per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAngularVelocity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Angle<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAngularVelocity<T>) -> Self::Output {
        Angle {
            rad: self.s.clone() / rhs.s_per_rad,
        }
    }
}
/// Dividing a Time by a InverseAngularVelocity returns a value of type Angle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Angle {
            rad: self.s / rhs.s_per_rad.clone(),
        }
    }
}
/// Dividing a Time by a InverseAngularVelocity returns a value of type Angle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAngularVelocity<T>) -> Self::Output {
        Angle {
            rad: self.s.clone() / rhs.s_per_rad.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InversePower {
            per_W: self.s.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InversePower {
            per_W: self.s.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseForce<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Momentum<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseForce<T>) -> Self::Output {
        Momentum {
            kgmps: self.s.clone() / rhs.per_N.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMomentum<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMomentum<T>) -> Self::Output {
        InverseForce {
            per_N: self.s.clone() * rhs.s_per_kgm,
        }
    }
}
/// Multiplying a Time by a InverseMomentum returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentum<T>) -> Self::Output {
        InverseForce {
            per_N: self.s * rhs.s_per_kgm.clone(),
        }
    }
}
/// Multiplying a Time by a InverseMomentum returns a value of type InverseForce
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMomentum<T>) -> Self::Output {
        InverseForce {
            per_N: self.s.clone() * rhs.s_per_kgm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePower<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePower<T>) -> Self::Output {
        Energy {
            J: self.s.clone() / rhs.per_W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Momentum<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseForce<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Momentum<T>) -> Self::Output {
        InverseForce {
            per_N: self.s.clone() / rhs.kgmps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Power<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Mul<TimePerDistance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &TimePerDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.s.clone() * rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<TimePerDistance<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
...
impl<T> core::ops::Mul<Velocity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = Distance<T>;
...
impl<T> core::ops::Div<Velocity<T>> for Time<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Velocity<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.s.clone() / rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Frequency<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        Frequency {
            Hz: T::from(self.clone()) / rhs.s.clone(),
        }
    }
}
...
// 1/Time -> Frequency
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
impl<T> core::ops::Div<Time<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Frequency<T>;
...
// 1/Time -> Frequency
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
impl<T> core::ops::Div<Time<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Frequency<T>;
...
// 1/Time -> Frequency
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
impl<T> core::ops::Div<Time<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Frequency<T>;
...
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Time<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Frequency<T>;
...
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Time<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Frequency<T>;
...
/// Dividing a scalar value by a Time unit value returns a value of type Frequency
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Time<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Frequency<T>;
