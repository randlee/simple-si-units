...
impl<T> fmt::Display for AbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_GGy(GGy: T) -> Self {
        AbsorbedDose {
            Gy: GGy * T::from(1000000000.0_f64),
        }
    }
...
impl<T> core::ops::Mul<Mass<T>> for AbsorbedDose<T>
where
    T: NumLike,
{
...
impl<T> fmt::Display for DoseEquivalent<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_GSv(GSv: T) -> Self {
        DoseEquivalent {
            Sv: GSv * T::from(1000000000.0_f64),
        }
    }
...
impl<T> core::ops::Mul<Mass<T>> for DoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_Gy(per_Gy: T) -> Self {
        InverseAbsorbedDose { per_Gy: per_Gy }
    }

    /// Returns a copy of this inverse absorbed dose value in inverse grays
    pub fn to_per_Gy(&self) -> T {
        self.per_Gy.clone()
    }
    ...
    pub fn from_per_grays(per_grays: T) -> Self {
        InverseAbsorbedDose { per_Gy: per_grays }
    }

    /// Returns a copy of this inverse absorbed dose value in inverse grays
    pub fn to_per_grays(&self) -> T {
        self.per_Gy.clone()
    }
}

impl<T> fmt::Display for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mGy(per_mGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_mGy * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uGy(per_uGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_uGy * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nGy(per_nGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_nGy * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_kGy(per_kGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_kGy * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_MGy(per_MGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_MGy * T::from(1e-06_f64),
        }
    }
    ...
    pub fn from_per_GGy(per_GGy: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_GGy * T::from(1e-09_f64),
        }
    }
    ...
    pub fn from_per_rad(per_rad: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_rad * T::from(100.0_f64),
        }
    }
    ...
    pub fn from_per_krad(per_krad: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_krad * T::from(0.1_f64),
        }
    }
    ...
    pub fn from_per_mrad(per_mrad: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_mrad * T::from(100000.0_f64),
        }
    }
    ...
    pub fn from_per_urad(per_urad: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_urad * T::from(100000000.0_f64),
        }
    }
    ...
    pub fn from_per_erg(per_erg: T) -> Self {
        InverseAbsorbedDose {
            per_Gy: per_erg * T::from(10000.0_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseAbsorbedDose<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseAbsorbedDose<num_bigfloat::BigFloat>) -> Self::Output {
        InverseAbsorbedDose {
            per_Gy: self.clone() * rhs.per_Gy.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Distance<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Distance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Gy.clone() * rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Gy.clone() / rhs.per_m,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseDistance returns a value of type InverseAcceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Gy / rhs.per_m.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseDistance returns a value of type InverseAcceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Gy.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMass<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy.clone() * rhs.per_kg,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a InverseMass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy * rhs.per_kg.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a InverseMass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTemperature<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy / rhs.per_K,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy.clone() / rhs.per_K,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy / rhs.per_K.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy.clone() / rhs.per_K.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy.clone() / rhs.kg,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a Mass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy / rhs.kg.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a Mass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Gy.clone() / rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Temperature<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InverseSpecificHeatCapacity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy.clone() * rhs.K,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Temperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy * rhs.K.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Temperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Gy.clone() * rhs.K.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSpecificHeatCapacity<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy / rhs.kgK_per_J,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy.clone() / rhs.kgK_per_J,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy / rhs.kgK_per_J.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy.clone() / rhs.kgK_per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<SpecificHeatCapacity<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InverseTemperature<T>;
    fn mul(self, rhs: SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy * rhs.J_per_kgK,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy.clone() * rhs.J_per_kgK,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy * rhs.J_per_kgK.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Gy.clone() * rhs.J_per_kgK.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Acceleration<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy.clone() * rhs.mps2,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Acceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy * rhs.mps2.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Acceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy.clone() * rhs.mps2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Density<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy.clone() / rhs.kgpm3,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a Density returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy / rhs.kgpm3.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a Density returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy.clone() / rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAcceleration<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy.clone() / rhs.s2pm,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseAcceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy / rhs.s2pm.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseAcceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Gy.clone() / rhs.s2pm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() / rhs.per_J,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseEnergy returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy / rhs.per_J.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseEnergy returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() / rhs.per_Nm,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseTorque returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy / rhs.per_Nm.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InverseTorque returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Gy.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePressure<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy.clone() / rhs.per_Pa,
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InversePressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy / rhs.per_Pa.clone(),
        }
    }
}
/// Dividing a InverseAbsorbedDose by a InversePressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy.clone() / rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Pressure<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy.clone() * rhs.Pa,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Pressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy * rhs.Pa.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a Pressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Gy.clone() * rhs.Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Div<TimePerDistance<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &TimePerDistance<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_Gy.clone() / rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Velocity<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Velocity<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_Gy.clone() * rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<VolumePerMass<T>> for InverseAbsorbedDose<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy.clone() * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy * rhs.m3_per_kg.clone(),
        }
    }
}
/// Multiplying a InverseAbsorbedDose by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Gy.clone() * rhs.m3_per_kg.clone(),
        }
    }
}
    ...
    T: NumLike,
{
    ...
    pub fn from_per_Sv(per_Sv: T) -> Self {
        InverseDoseEquivalent { per_Sv: per_Sv }
    }
...
impl<T> fmt::Display for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mSv(per_mSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_mSv * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uSv(per_uSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_uSv * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nSv(per_nSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_nSv * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_kSv(per_kSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_kSv * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_MSv(per_MSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_MSv * T::from(1e-06_f64),
        }
    }
    ...
    pub fn from_per_GSv(per_GSv: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_GSv * T::from(1e-09_f64),
        }
    }
    ...
    pub fn from_per_rem(per_rem: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_rem * T::from(100.0_f64),
        }
    }
    ...
    pub fn from_per_mrem(per_mrem: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_mrem * T::from(100000.0_f64),
        }
    }
    ...
    pub fn from_per_krem(per_krem: T) -> Self {
        InverseDoseEquivalent {
            per_Sv: per_krem * T::from(0.1_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseDoseEquivalent<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseDoseEquivalent<num_bigfloat::BigFloat>) -> Self::Output {
        InverseDoseEquivalent {
            per_Sv: self.clone() * rhs.per_Sv.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Distance<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Distance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Sv.clone() * rhs.m.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseDistance<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseAcceleration<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Sv.clone() / rhs.per_m,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseDistance returns a value of type InverseAcceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Sv / rhs.per_m.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseDistance returns a value of type InverseAcceleration
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseDistance<T>) -> Self::Output {
        InverseAcceleration {
            s2pm: self.per_Sv.clone() / rhs.per_m.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMass<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv.clone() * rhs.per_kg,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a InverseMass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv * rhs.per_kg.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a InverseMass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv.clone() * rhs.per_kg.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTemperature<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseSpecificHeatCapacity<T>;
    fn div(self, rhs: InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv / rhs.per_K,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv.clone() / rhs.per_K,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv / rhs.per_K.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseTemperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTemperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv.clone() / rhs.per_K.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Mass<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv.clone() / rhs.kg,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a Mass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv / rhs.kg.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a Mass returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Mass<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Sv.clone() / rhs.kg.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Temperature<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseSpecificHeatCapacity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv.clone() * rhs.K,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Temperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv * rhs.K.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Temperature returns a value of type InverseSpecificHeatCapacity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Temperature<T>) -> Self::Output {
        InverseSpecificHeatCapacity {
            kgK_per_J: self.per_Sv.clone() * rhs.K.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSpecificHeatCapacity<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseTemperature<T>;
    fn div(self, rhs: InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv / rhs.kgK_per_J,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv.clone() / rhs.kgK_per_J,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv / rhs.kgK_per_J.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseSpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv.clone() / rhs.kgK_per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<SpecificHeatCapacity<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseTemperature<T>;
    fn mul(self, rhs: SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv * rhs.J_per_kgK,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv.clone() * rhs.J_per_kgK,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv * rhs.J_per_kgK.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a SpecificHeatCapacity returns a value of type InverseTemperature
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SpecificHeatCapacity<T>) -> Self::Output {
        InverseTemperature {
            per_K: self.per_Sv.clone() * rhs.J_per_kgK.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Acceleration<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv.clone() * rhs.mps2,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Acceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv * rhs.mps2.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Acceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Acceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv.clone() * rhs.mps2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Density<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv.clone() / rhs.kgpm3,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a Density returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv / rhs.kgpm3.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a Density returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Density<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv.clone() / rhs.kgpm3.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseAcceleration<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InverseDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv.clone() / rhs.s2pm,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseAcceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv / rhs.s2pm.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseAcceleration returns a value of type InverseDistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseAcceleration<T>) -> Self::Output {
        InverseDistance {
            per_m: self.per_Sv.clone() / rhs.s2pm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() / rhs.per_J,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseEnergy returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv / rhs.per_J.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseEnergy returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Mass<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() / rhs.per_Nm,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseTorque returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv / rhs.per_Nm.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InverseTorque returns a value of type Mass
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Mass {
            kg: self.per_Sv.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePressure<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv.clone() / rhs.per_Pa,
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InversePressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv / rhs.per_Pa.clone(),
        }
    }
}
/// Dividing a InverseDoseEquivalent by a InversePressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv.clone() / rhs.per_Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Pressure<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = Density<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv.clone() * rhs.Pa,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Pressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv * rhs.Pa.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a Pressure returns a value of type Density
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Pressure<T>) -> Self::Output {
        Density {
            kgpm3: self.per_Sv.clone() * rhs.Pa.clone(),
        }
    }
}
...
impl<T> core::ops::Div<TimePerDistance<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &TimePerDistance<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_Sv.clone() / rhs.spm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Velocity<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = TimePerDistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Velocity<T>) -> Self::Output {
        TimePerDistance {
            spm: self.per_Sv.clone() * rhs.mps.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<VolumePerMass<T>> for InverseDoseEquivalent<T>
where
    T: NumLike,
{
    type Output = InversePressure<T>;
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv.clone() * rhs.m3_per_kg,
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv * rhs.m3_per_kg.clone(),
        }
    }
}
/// Multiplying a InverseDoseEquivalent by a VolumePerMass returns a value of type InversePressure
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &VolumePerMass<T>) -> Self::Output {
        InversePressure {
            per_Pa: self.per_Sv.clone() * rhs.m3_per_kg.clone(),
        }
    }
}
...
impl<T> fmt::Display for Radioactivity<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_GBq(GBq: T) -> Self {
        Radioactivity {
            Bq: GBq * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_Ci(Ci: T) -> Self {
        Radioactivity {
            Bq: Ci * T::from(37000000000.0_f64),
        }
    }
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Radioactivity> for Radioactivity<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Radioactivity> for Radioactivity<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Radioactivity> for Radioactivity<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Radioactivity> for Radioactivity<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Radioactivity<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Time<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Radioactivity<T>) -> Self::Output {
        Time {
            s: T::from(self.clone()) / rhs.Bq.clone(),
        }
    }
}
...
// 1/Radioactivity -> Time
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
impl<T> core::ops::Div<Radioactivity<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Time<T>;
...
// 1/Radioactivity -> Time
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
impl<T> core::ops::Div<Radioactivity<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Time<T>;
...
// 1/Radioactivity -> Time
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
impl<T> core::ops::Div<Radioactivity<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Time<T>;
...
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Radioactivity<T>> for num_bigfloat::BigFloat
where
...
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Radioactivity<T>> for num_complex::Complex32
where
...
/// Dividing a scalar value by a Radioactivity unit value returns a value of type Time
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Radioactivity<T>> for num_complex::Complex64
where
