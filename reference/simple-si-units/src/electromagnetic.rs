    ...
    T: NumLike,
{
    ...
    pub fn from_m2_per_lm(m2_per_lm: T) -> Self {
        AreaPerLumen {
            m2_per_lm: m2_per_lm,
        }
    }
    ...
    pub fn to_m2_per_lm(&self) -> T {
        self.m2_per_lm.clone()
    }
    ...
    pub fn from_square_meters_per_lumen(square_meters_per_lumen: T) -> Self {
        AreaPerLumen {
            m2_per_lm: square_meters_per_lumen,
        }
    }

    /// Returns a copy of this area per lumen value in square meters per lumen
    pub fn to_square_meters_per_lumen(&self) -> T {
        self.m2_per_lm.clone()
    }
    ...
    pub fn from_per_lux(per_lux: T) -> Self {
        AreaPerLumen { m2_per_lm: per_lux }
    }

    /// Returns a copy of this area per lumen value in inverse lux
    pub fn to_per_lux(&self) -> T {
        self.m2_per_lm.clone()
    }
}

impl<T> fmt::Display for AreaPerLumen<T>
where
    T: NumLike,
{
...
impl core::ops::Mul<AreaPerLumen<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: AreaPerLumen<num_bigfloat::BigFloat>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.clone() * rhs.m2_per_lm,
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&AreaPerLumen<num_bigfloat::BigFloat>> for num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &AreaPerLumen<num_bigfloat::BigFloat>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self * rhs.m2_per_lm.clone(),
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
...
impl core::ops::Mul<&AreaPerLumen<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &AreaPerLumen<num_bigfloat::BigFloat>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.clone() * rhs.m2_per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminousFlux<T>> for AreaPerLumen<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm.clone() / rhs.per_lm,
        }
    }
}
/// Dividing a AreaPerLumen by a InverseLuminousFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm / rhs.per_lm.clone(),
        }
    }
}
/// Dividing a AreaPerLumen by a InverseLuminousFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm.clone() / rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<LuminousFlux<T>> for AreaPerLumen<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: LuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm.clone() * rhs.lm,
        }
    }
}
/// Multiplying a AreaPerLumen by a LuminousFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &LuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm * rhs.lm.clone(),
        }
    }
}
/// Multiplying a AreaPerLumen by a LuminousFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &LuminousFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_lm.clone() * rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for AreaPerLumen<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Area<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm.clone() / rhs.m2,
        }
    }
}
/// Dividing a AreaPerLumen by a Area returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm / rhs.m2.clone(),
        }
    }
}
/// Dividing a AreaPerLumen by a Area returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for AreaPerLumen<T>
where
    T: NumLike,
{
    type Output = InverseLuminousFlux<T>;
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm * rhs.per_m2,
        }
    }
}
/// Multiplying a AreaPerLumen by a InverseArea returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm.clone() * rhs.per_m2,
        }
    }
}
/// Multiplying a AreaPerLumen by a InverseArea returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm * rhs.per_m2.clone(),
        }
    }
}
/// Multiplying a AreaPerLumen by a InverseArea returns a value of type InverseLuminousFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.m2_per_lm.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerLumen<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        Illuminance {
            lux: T::from(self.clone()) / rhs.m2_per_lm,
        }
    }
}
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        Illuminance {
            lux: T::from(self) / rhs.m2_per_lm.clone(),
        }
    }
}
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        Illuminance {
            lux: T::from(self.clone()) / rhs.m2_per_lm.clone(),
        }
    }
}
...
// 1/AreaPerLumen -> Illuminance
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
impl<T> core::ops::Div<AreaPerLumen<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Illuminance<T>;
...
// 1/AreaPerLumen -> Illuminance
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
impl<T> core::ops::Div<AreaPerLumen<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Illuminance<T>;
...
// 1/AreaPerLumen -> Illuminance
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
impl<T> core::ops::Div<AreaPerLumen<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Illuminance<T>;
...
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<AreaPerLumen<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Illuminance<T>;
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        Illuminance {
...
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<AreaPerLumen<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Illuminance<T>;
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        Illuminance {
...
/// Dividing a scalar value by a AreaPerLumen unit value returns a value of type Illuminance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<AreaPerLumen<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Illuminance<T>;
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        Illuminance {
...
impl<T> fmt::Display for Capacitance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Capacitance> for Capacitance<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Capacitance> for Capacitance<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Capacitance> for Capacitance<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Capacitance> for Capacitance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Time<T>> for Capacitance<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Charge<T>> for Capacitance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.F.clone() / rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Conductance<T>> for Capacitance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<InverseCharge<T>> for Capacitance<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.F.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for Capacitance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Charge {
            C: self.F.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for Capacitance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<Voltage<T>> for Capacitance<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Mul<Frequency<T>> for Capacitance<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
...
impl<T> core::ops::Div<Capacitance<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Capacitance<T>) -> Self::Output {
        Elastance {
            per_F: T::from(self.clone()) / rhs.F.clone(),
        }
    }
}
...
// 1/Capacitance -> Elastance
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
impl<T> core::ops::Div<Capacitance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Elastance<T>;
...
// 1/Capacitance -> Elastance
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
impl<T> core::ops::Div<Capacitance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Elastance<T>;
...
// 1/Capacitance -> Elastance
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
impl<T> core::ops::Div<Capacitance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Elastance<T>;
...
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Capacitance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Elastance<T>;
...
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Capacitance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Elastance<T>;
...
/// Dividing a scalar value by a Capacitance unit value returns a value of type Elastance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Capacitance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Elastance<T>;
...
impl<T> fmt::Display for Charge<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_p(p: T) -> Self {
        Charge {
            C: p * T::from(1.6021766340000001e-19_f64),
        }
    }
    ...
    pub fn from_e(e: T) -> Self {
        Charge {
            C: e * T::from(-1.6021766340000001e-19_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ElectricCharge> for Charge<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ElectricCharge> for Charge<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ElectricCharge> for Charge<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ElectricCharge> for Charge<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Current<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<InverseCurrent<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Time {
            s: self.C.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for Charge<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Capacitance<T>> for Charge<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Conductance<T>> for Charge<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Mul<Elastance<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Elastance<T>) -> Self::Output {
        Voltage {
            V: self.C.clone() * rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Conductance {
            S: self.C.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for Charge<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Capacitance {
            F: self.C.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for Charge<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Energy {
            J: self.C.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
...
impl<T> core::ops::Mul<Resistance<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Mul<Voltage<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<Voltage<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
...
impl<T> core::ops::Div<Energy<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.C.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.C.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = Current<T>;
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.C.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Charge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.C.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Charge<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        InverseCharge {
            per_C: T::from(self.clone()) / rhs.C.clone(),
        }
    }
}
...
// 1/Charge -> InverseCharge
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
impl<T> core::ops::Div<Charge<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseCharge<T>;
...
// 1/Charge -> InverseCharge
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
impl<T> core::ops::Div<Charge<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseCharge<T>;
...
// 1/Charge -> InverseCharge
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
impl<T> core::ops::Div<Charge<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseCharge<T>;
...
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Charge<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseCharge<T>;
...
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Charge<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseCharge<T>;
...
/// Dividing a scalar value by a Charge unit value returns a value of type InverseCharge
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Charge<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseCharge<T>;
...
impl<T> fmt::Display for Conductance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ElectricalConductance> for Conductance<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::ElectricalConductance {
        uom::si::f32::ElectricalConductance::new::<uom::si::electrical_conductance::siemens>(
            self.S.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ElectricalConductance> for Conductance<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ElectricalConductance> for Conductance<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::ElectricalConductance {
        uom::si::f64::ElectricalConductance::new::<uom::si::electrical_conductance::siemens>(
            self.S.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ElectricalConductance> for Conductance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Div<Current<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Current<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.S.clone() / rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCurrent<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.S.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
...
impl<T> core::ops::Div<Time<T>> for Conductance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        InverseInductance {
            per_H: self.S.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Capacitance<T>> for Conductance<T>
where
    T: NumLike,
{
...
impl<T> core::ops::Div<Charge<T>> for Conductance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.S.clone() / rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Elastance<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Elastance<T>) -> Self::Output {
        Frequency {
            Hz: self.S.clone() * rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Inductance<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<InverseCharge<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.S.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseInductance<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseInductance<T>) -> Self::Output {
        Time {
            s: self.S.clone() / rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Charge {
            C: self.S.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Current {
            A: self.S.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Mul<Voltage<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Current<T>;
...
impl<T> core::ops::Mul<Frequency<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        InverseInductance {
            per_H: self.S.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for Conductance<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
...
impl<T> core::ops::Div<Conductance<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Conductance<T>) -> Self::Output {
        Resistance {
            Ohm: T::from(self.clone()) / rhs.S.clone(),
        }
    }
}
...
// 1/Conductance -> Resistance
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
impl<T> core::ops::Div<Conductance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Resistance<T>;
...
// 1/Conductance -> Resistance
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
impl<T> core::ops::Div<Conductance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Resistance<T>;
...
// 1/Conductance -> Resistance
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
impl<T> core::ops::Div<Conductance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Resistance<T>;
...
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Conductance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Resistance<T>;
...
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Conductance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Resistance<T>;
...
/// Dividing a scalar value by a Conductance unit value returns a value of type Resistance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Conductance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_F(per_F: T) -> Self {
        Elastance { per_F: per_F }
    }

    /// Returns a copy of this electrical elastance value in inverse farads
    pub fn to_per_F(&self) -> T {
        self.per_F.clone()
    }
    ...
    pub fn from_per_farads(per_farads: T) -> Self {
        Elastance { per_F: per_farads }
    }

    /// Returns a copy of this electrical elastance value in inverse farads
    pub fn to_per_farads(&self) -> T {
        self.per_F.clone()
    }
}

impl<T> fmt::Display for Elastance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mF(per_mF: T) -> Self {
        Elastance {
            per_F: per_mF * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uF(per_uF: T) -> Self {
        Elastance {
            per_F: per_uF * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nF(per_nF: T) -> Self {
        Elastance {
            per_F: per_nF * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_pF(per_pF: T) -> Self {
        Elastance {
            per_F: per_pF * T::from(1000000000000.0_f64),
        }
    }
...
impl core::ops::Mul<&Elastance<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &Elastance<num_bigfloat::BigFloat>) -> Self::Output {
        Elastance {
            per_F: self.clone() * rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_F.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Charge<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Charge<T>) -> Self::Output {
        Voltage {
            V: self.per_F.clone() * rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Conductance<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Conductance<T>) -> Self::Output {
        Frequency {
            Hz: self.per_F.clone() * rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Voltage {
            V: self.per_F.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVoltage<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_F.clone() * rhs.per_V,
        }
    }
}
/// Multiplying a Elastance by a InverseVoltage returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_F * rhs.per_V.clone(),
        }
    }
}
/// Multiplying a Elastance by a InverseVoltage returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_F.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Resistance<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        Frequency {
            Hz: self.per_F.clone() / rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Voltage<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Voltage<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_F.clone() / rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for Elastance<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_F.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Elastance<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Capacitance<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Elastance<T>) -> Self::Output {
        Capacitance {
            F: T::from(self.clone()) / rhs.per_F.clone(),
        }
    }
}
...
// 1/Elastance -> Capacitance
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
impl<T> core::ops::Div<Elastance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Capacitance<T>;
...
// 1/Elastance -> Capacitance
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
impl<T> core::ops::Div<Elastance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Capacitance<T>;
...
// 1/Elastance -> Capacitance
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
impl<T> core::ops::Div<Elastance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Capacitance<T>;
...
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Elastance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Capacitance<T>;
...
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Elastance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Capacitance<T>;
...
/// Dividing a scalar value by a Elastance unit value returns a value of type Capacitance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Elastance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Capacitance<T>;
...
impl<T> fmt::Display for Illuminance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_Glux(Glux: T) -> Self {
        Illuminance {
            lux: Glux * T::from(1000000000.0_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Luminance> for Illuminance<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::Luminance {
        uom::si::f32::Luminance::new::<uom::si::luminance::candela_per_square_meter>(
            self.lux.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Luminance> for Illuminance<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::Luminance) -> Self {
        Illuminance {
            lux: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Luminance> for Illuminance<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::Luminance {
        uom::si::f64::Luminance::new::<uom::si::luminance::candela_per_square_meter>(
            self.lux.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Luminance> for Illuminance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<InverseLuminousFlux<T>> for Illuminance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.lux.clone() * rhs.per_lm,
        }
    }
}
/// Multiplying a Illuminance by a InverseLuminousFlux returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.lux * rhs.per_lm.clone(),
        }
    }
}
/// Multiplying a Illuminance by a InverseLuminousFlux returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.lux.clone() * rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<LuminousFlux<T>> for Illuminance<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.lux.clone() / rhs.lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for Illuminance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        LuminousFlux {
            lm: self.lux.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for Illuminance<T>
where
    T: NumLike,
{
    type Output = LuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        LuminousFlux {
            lm: self.lux.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Illuminance<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: Illuminance<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: T::from(self.clone()) / rhs.lux,
        }
    }
}
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Illuminance<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: T::from(self) / rhs.lux.clone(),
        }
    }
}
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Illuminance<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: T::from(self.clone()) / rhs.lux.clone(),
        }
    }
}
...
// 1/Illuminance -> AreaPerLumen
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
impl<T> core::ops::Div<Illuminance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = AreaPerLumen<T>;
...
// 1/Illuminance -> AreaPerLumen
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
impl<T> core::ops::Div<Illuminance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = AreaPerLumen<T>;
...
// 1/Illuminance -> AreaPerLumen
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
impl<T> core::ops::Div<Illuminance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = AreaPerLumen<T>;
...
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Illuminance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = AreaPerLumen<T>;
...
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Illuminance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = AreaPerLumen<T>;
...
/// Dividing a scalar value by a Illuminance unit value returns a value of type AreaPerLumen
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Illuminance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = AreaPerLumen<T>;
...
impl<T> fmt::Display for Inductance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::Inductance> for Inductance<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::Inductance> for Inductance<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::Inductance> for Inductance<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::Inductance> for Inductance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Current<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Div<InverseCurrent<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.H.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
...
impl<T> core::ops::Mul<Conductance<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Inductance<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.H.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.H.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Resistance<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<Frequency<T>> for Inductance<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
...
impl<T> core::ops::Div<Inductance<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Inductance<T>) -> Self::Output {
        InverseInductance {
            per_H: T::from(self.clone()) / rhs.H.clone(),
        }
    }
}
...
// 1/Inductance -> InverseInductance
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
impl<T> core::ops::Div<Inductance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseInductance<T>;
...
// 1/Inductance -> InverseInductance
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
impl<T> core::ops::Div<Inductance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseInductance<T>;
...
// 1/Inductance -> InverseInductance
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
impl<T> core::ops::Div<Inductance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseInductance<T>;
...
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Inductance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseInductance<T>;
...
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Inductance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseInductance<T>;
...
/// Dividing a scalar value by a Inductance unit value returns a value of type InverseInductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Inductance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_C(per_C: T) -> Self {
        InverseCharge { per_C: per_C }
    }

    /// Returns a copy of this inverse electric charge value in inverse coulombs
    pub fn to_per_C(&self) -> T {
        self.per_C.clone()
    }
    ...
    pub fn from_per_coulombs(per_coulombs: T) -> Self {
        InverseCharge {
            per_C: per_coulombs,
        }
    }
    ...
    /// Returns a copy of this inverse electric charge value in inverse coulombs
    pub fn to_per_coulombs(&self) -> T {
        self.per_C.clone()
    }
}

impl<T> fmt::Display for InverseCharge<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mC(per_mC: T) -> Self {
        InverseCharge {
            per_C: per_mC * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uC(per_uC: T) -> Self {
        InverseCharge {
            per_C: per_uC * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nC(per_nC: T) -> Self {
        InverseCharge {
            per_C: per_nC * T::from(1000000000.0_f64),
        }
    }
...
impl core::ops::Mul<&InverseCharge<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseCharge<num_bigfloat::BigFloat>) -> Self::Output {
        InverseCharge {
            per_C: self.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Current<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Current<T>) -> Self::Output {
        Frequency {
            Hz: self.per_C.clone() * rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Frequency {
            Hz: self.per_C.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_C.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Capacitance<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Capacitance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_C.clone() * rhs.F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Conductance<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Conductance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_C.clone() * rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Elastance<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Elastance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_C.clone() / rhs.per_F,
        }
    }
}
/// Dividing a InverseCharge by a Elastance returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Elastance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_C / rhs.per_F.clone(),
        }
    }
}
/// Dividing a InverseCharge by a Elastance returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Elastance<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_C.clone() / rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_C.clone() / rhs.per_Wb,
        }
    }
}
/// Dividing a InverseCharge by a InverseMagneticFlux returns a value of type Resistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_C / rhs.per_Wb.clone(),
        }
    }
}
/// Dividing a InverseCharge by a InverseMagneticFlux returns a value of type Resistance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_C.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for InverseCharge<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVoltage<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_C.clone() * rhs.per_V,
        }
    }
}
/// Multiplying a InverseCharge by a InverseVoltage returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_C * rhs.per_V.clone(),
        }
    }
}
/// Multiplying a InverseCharge by a InverseVoltage returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_C.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVoltage<T>) -> Self::Output {
        Elastance {
            per_F: self.per_C.clone() / rhs.per_V,
        }
    }
}
/// Dividing a InverseCharge by a InverseVoltage returns a value of type Elastance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Elastance {
            per_F: self.per_C / rhs.per_V.clone(),
        }
    }
}
/// Dividing a InverseCharge by a InverseVoltage returns a value of type Elastance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Elastance {
            per_F: self.per_C.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Resistance {
            Ohm: self.per_C.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Resistance<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Resistance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_C.clone() / rhs.Ohm,
        }
    }
}
/// Dividing a InverseCharge by a Resistance returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_C / rhs.Ohm.clone(),
        }
    }
}
/// Dividing a InverseCharge by a Resistance returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_C.clone() / rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Voltage<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Voltage<T>) -> Self::Output {
        Elastance {
            per_F: self.per_C.clone() * rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Voltage<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Voltage<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_C.clone() / rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Voltage {
            V: self.per_C.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Voltage {
            V: self.per_C.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_C.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Voltage {
            V: self.per_C.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseCharge<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Voltage {
            V: self.per_C.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Charge<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Charge {
            C: T::from(self.clone()) / rhs.per_C.clone(),
        }
    }
}
...
// 1/InverseCharge -> Charge
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
impl<T> core::ops::Div<InverseCharge<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Charge<T>;
...
// 1/InverseCharge -> Charge
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
impl<T> core::ops::Div<InverseCharge<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Charge<T>;
...
// 1/InverseCharge -> Charge
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
impl<T> core::ops::Div<InverseCharge<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Charge<T>;
...
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseCharge<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Charge<T>;
...
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseCharge<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Charge<T>;
...
/// Dividing a scalar value by a InverseCharge unit value returns a value of type Charge
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseCharge<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_H(per_H: T) -> Self {
        InverseInductance { per_H: per_H }
    }

    /// Returns a copy of this inverse inductance value in inverse henries
    pub fn to_per_H(&self) -> T {
        self.per_H.clone()
    }
    ...
    pub fn from_per_henry(per_henry: T) -> Self {
        InverseInductance { per_H: per_henry }
    }

    /// Returns a copy of this inverse inductance value in inverse henries
    pub fn to_per_henry(&self) -> T {
        self.per_H.clone()
    }
}

impl<T> fmt::Display for InverseInductance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mH(per_mH: T) -> Self {
        InverseInductance {
            per_H: per_mH * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uH(per_uH: T) -> Self {
        InverseInductance {
            per_H: per_uH * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nH(per_nH: T) -> Self {
        InverseInductance {
            per_H: per_nH * T::from(1000000000.0_f64),
        }
    }
...
impl core::ops::Mul<&InverseInductance<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseInductance<num_bigfloat::BigFloat>) -> Self::Output {
        InverseInductance {
            per_H: self.clone() * rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Current<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Current<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_H.clone() / rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCurrent<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseCurrent<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_H.clone() * rhs.per_A,
        }
    }
}
/// Multiplying a InverseInductance by a InverseCurrent returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_H * rhs.per_A.clone(),
        }
    }
}
/// Multiplying a InverseInductance by a InverseCurrent returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_H.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        Conductance {
            S: self.per_H.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Conductance<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Conductance<T>) -> Self::Output {
        Frequency {
            Hz: self.per_H.clone() / rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Current {
            A: self.per_H.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Current {
            A: self.per_H.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Resistance<T>) -> Self::Output {
        Frequency {
            Hz: self.per_H.clone() * rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseInductance<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        Conductance {
            S: self.per_H.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseInductance<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseInductance<T>) -> Self::Output {
        Inductance {
            H: T::from(self.clone()) / rhs.per_H.clone(),
        }
    }
}
...
// 1/InverseInductance -> Inductance
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
impl<T> core::ops::Div<InverseInductance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Inductance<T>;
...
// 1/InverseInductance -> Inductance
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
impl<T> core::ops::Div<InverseInductance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Inductance<T>;
...
// 1/InverseInductance -> Inductance
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
impl<T> core::ops::Div<InverseInductance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Inductance<T>;
...
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseInductance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Inductance<T>;
...
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseInductance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Inductance<T>;
...
/// Dividing a scalar value by a InverseInductance unit value returns a value of type Inductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseInductance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Inductance<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_lm(per_lm: T) -> Self {
        InverseLuminousFlux { per_lm: per_lm }
    }

    /// Returns a copy of this inverse luminous flux value in inverse lumens
    pub fn to_per_lm(&self) -> T {
        self.per_lm.clone()
    }
    ...
    pub fn from_per_lumens(per_lumens: T) -> Self {
        InverseLuminousFlux { per_lm: per_lumens }
    }

    /// Returns a copy of this inverse luminous flux value in inverse lumens
    pub fn to_per_lumens(&self) -> T {
        self.per_lm.clone()
    }
}

impl<T> fmt::Display for InverseLuminousFlux<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mlm(per_mlm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_mlm * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_ulm(per_ulm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_ulm * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nlm(per_nlm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_nlm * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_klm(per_klm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_klm * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_Mlm(per_Mlm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_Mlm * T::from(1e-06_f64),
        }
    }
    ...
    pub fn from_per_Glm(per_Glm: T) -> Self {
        InverseLuminousFlux {
            per_lm: per_Glm * T::from(1e-09_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseLuminousFlux<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseLuminousFlux<num_bigfloat::BigFloat>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: self.clone() * rhs.per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminosity<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseLuminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm.clone() / rhs.per_cd,
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseLuminosity returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm / rhs.per_cd.clone(),
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseLuminosity returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm.clone() / rhs.per_cd.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Luminosity<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = InverseSolidAngle<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Luminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm.clone() * rhs.cd,
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Luminosity returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm * rhs.cd.clone(),
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Luminosity returns a value of type InverseSolidAngle
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Luminosity<T>) -> Self::Output {
        InverseSolidAngle {
            per_sr: self.per_lm.clone() * rhs.cd.clone(),
        }
    }
}
...
impl<T> core::ops::Div<AreaPerLumen<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm / rhs.m2_per_lm,
        }
    }
}
/// Dividing a InverseLuminousFlux by a AreaPerLumen returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: AreaPerLumen<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm.clone() / rhs.m2_per_lm,
        }
    }
}
/// Dividing a InverseLuminousFlux by a AreaPerLumen returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm / rhs.m2_per_lm.clone(),
        }
    }
}
/// Dividing a InverseLuminousFlux by a AreaPerLumen returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm.clone() / rhs.m2_per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Illuminance<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Illuminance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm.clone() * rhs.lux,
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Illuminance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Illuminance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm * rhs.lux.clone(),
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Illuminance returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Illuminance<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_lm.clone() * rhs.lux.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = AreaPerLumen<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Area<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm.clone() * rhs.m2,
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Area returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm * rhs.m2.clone(),
        }
    }
}
/// Multiplying a InverseLuminousFlux by a Area returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = AreaPerLumen<T>;
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm / rhs.per_m2,
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseArea returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm.clone() / rhs.per_m2,
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseArea returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm / rhs.per_m2.clone(),
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseArea returns a value of type AreaPerLumen
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        AreaPerLumen {
            m2_per_lm: self.per_lm.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseSolidAngle<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseSolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm.clone() / rhs.per_sr,
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseSolidAngle returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm / rhs.per_sr.clone(),
        }
    }
}
/// Dividing a InverseLuminousFlux by a InverseSolidAngle returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm.clone() / rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<SolidAngle<T>> for InverseLuminousFlux<T>
where
    T: NumLike,
{
    type Output = InverseLuminosity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: SolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm.clone() * rhs.sr,
        }
    }
}
/// Multiplying a InverseLuminousFlux by a SolidAngle returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm * rhs.sr.clone(),
        }
    }
}
/// Multiplying a InverseLuminousFlux by a SolidAngle returns a value of type InverseLuminosity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &SolidAngle<T>) -> Self::Output {
        InverseLuminosity {
            per_cd: self.per_lm.clone() * rhs.sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseLuminousFlux<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = LuminousFlux<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseLuminousFlux<T>) -> Self::Output {
        LuminousFlux {
            lm: T::from(self.clone()) / rhs.per_lm,
        }
    }
}
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        LuminousFlux {
            lm: T::from(self) / rhs.per_lm.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseLuminousFlux<T>) -> Self::Output {
        LuminousFlux {
            lm: T::from(self.clone()) / rhs.per_lm.clone(),
        }
    }
}
...
// 1/InverseLuminousFlux -> LuminousFlux
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
impl<T> core::ops::Div<InverseLuminousFlux<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = LuminousFlux<T>;
...
// 1/InverseLuminousFlux -> LuminousFlux
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
impl<T> core::ops::Div<InverseLuminousFlux<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = LuminousFlux<T>;
...
// 1/InverseLuminousFlux -> LuminousFlux
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
impl<T> core::ops::Div<InverseLuminousFlux<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = LuminousFlux<T>;
...
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseLuminousFlux<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = LuminousFlux<T>;
...
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseLuminousFlux<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = LuminousFlux<T>;
...
/// Dividing a scalar value by a InverseLuminousFlux unit value returns a value of type LuminousFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseLuminousFlux<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = LuminousFlux<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_Wb(per_Wb: T) -> Self {
        InverseMagneticFlux { per_Wb: per_Wb }
    }

    /// Returns a copy of this inverse magnetic flux value in inverse webers
    pub fn to_per_Wb(&self) -> T {
        self.per_Wb.clone()
    }
    ...
    pub fn from_per_weber(per_weber: T) -> Self {
        InverseMagneticFlux { per_Wb: per_weber }
    }

    /// Returns a copy of this inverse magnetic flux value in inverse webers
    pub fn to_per_weber(&self) -> T {
        self.per_Wb.clone()
    }
}

impl<T> fmt::Display for InverseMagneticFlux<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mWb(per_mWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_mWb * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uWb(per_uWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_uWb * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nWb(per_nWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_nWb * T::from(1000000000.0_f64),
        }
    }
    ...
    pub fn from_per_kWb(per_kWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_kWb * T::from(0.001_f64),
        }
    }
    ...
    pub fn from_per_MWb(per_MWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_MWb * T::from(1e-06_f64),
        }
    }
    ...
    pub fn from_per_GWb(per_GWb: T) -> Self {
        InverseMagneticFlux {
            per_Wb: per_GWb * T::from(1e-09_f64),
        }
    }
}
...
impl core::ops::Mul<&InverseMagneticFlux<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseMagneticFlux<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Current<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Current<T>) -> Self::Output {
        InverseInductance {
            per_H: self.per_Wb.clone() * rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Current<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Current<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Wb.clone() / rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCurrent<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseCurrent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Wb.clone() * rhs.per_A,
        }
    }
}
/// Multiplying a InverseMagneticFlux by a InverseCurrent returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Wb * rhs.per_A.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFlux by a InverseCurrent returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_Wb.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseInductance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseCurrent<T>) -> Self::Output {
        InverseInductance {
            per_H: self.per_Wb.clone() / rhs.per_A,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseCurrent returns a value of type InverseInductance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseInductance {
            per_H: self.per_Wb / rhs.per_A.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseCurrent returns a value of type InverseInductance
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InverseInductance {
            per_H: self.per_Wb.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Time<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_Wb.clone() * rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Charge<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Charge<T>) -> Self::Output {
        Conductance {
            S: self.per_Wb.clone() * rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Conductance<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Conductance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_Wb.clone() / rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Inductance<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Inductance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_Wb.clone() * rhs.H.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Conductance {
            S: self.per_Wb.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseInductance<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseInductance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_Wb.clone() / rhs.per_H,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseInductance returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseInductance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_Wb / rhs.per_H.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseInductance returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseInductance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_Wb.clone() / rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    fn div(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb / rhs.m2_per_Wb,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseMagneticFluxDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb.clone() / rhs.m2_per_Wb,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseMagneticFluxDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb / rhs.m2_per_Wb.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseMagneticFluxDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb.clone() / rhs.m2_per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseVoltage<T>) -> Self::Output {
        Frequency {
            Hz: self.per_Wb.clone() / rhs.per_V,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseVoltage returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Frequency {
            Hz: self.per_Wb / rhs.per_V.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseVoltage returns a value of type Frequency
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Frequency {
            Hz: self.per_Wb.clone() / rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFluxDensity<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: MagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb.clone() * rhs.T,
        }
    }
}
/// Multiplying a InverseMagneticFlux by a MagneticFluxDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb * rhs.T.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFlux by a MagneticFluxDensity returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseArea {
            per_m2: self.per_Wb.clone() * rhs.T.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Resistance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_Wb.clone() * rhs.Ohm,
        }
    }
}
/// Multiplying a InverseMagneticFlux by a Resistance returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Resistance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_Wb * rhs.Ohm.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFlux by a Resistance returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Resistance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_Wb.clone() * rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Voltage<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Voltage<T>) -> Self::Output {
        Frequency {
            Hz: self.per_Wb.clone() * rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Area<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb.clone() * rhs.m2,
        }
    }
}
/// Multiplying a InverseMagneticFlux by a Area returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb * rhs.m2.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFlux by a Area returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Area<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb.clone() * rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseArea<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFluxDensity<T>;
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb / rhs.per_m2,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseArea returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseArea<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb.clone() / rhs.per_m2,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseArea returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb / rhs.per_m2.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseArea returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.per_Wb.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Current {
            A: self.per_Wb.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Current {
            A: self.per_Wb.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Frequency<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_Wb.clone() / rhs.Hz,
        }
    }
}
/// Dividing a InverseMagneticFlux by a Frequency returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_Wb / rhs.Hz.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a Frequency returns a value of type InverseVoltage
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Frequency<T>) -> Self::Output {
        InverseVoltage {
            per_V: self.per_Wb.clone() / rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Current {
            A: self.per_Wb.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseMagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseTorque<T>) -> Self::Output {
        Current {
            A: self.per_Wb.clone() / rhs.per_Nm,
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseTorque returns a value of type Current
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Current {
            A: self.per_Wb / rhs.per_Nm.clone(),
        }
    }
}
/// Dividing a InverseMagneticFlux by a InverseTorque returns a value of type Current
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Current {
            A: self.per_Wb.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        MagneticFlux {
            Wb: T::from(self.clone()) / rhs.per_Wb,
        }
    }
}
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        MagneticFlux {
            Wb: T::from(self) / rhs.per_Wb.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        MagneticFlux {
            Wb: T::from(self.clone()) / rhs.per_Wb.clone(),
        }
    }
}
...
// 1/InverseMagneticFlux -> MagneticFlux
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
impl<T> core::ops::Div<InverseMagneticFlux<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = MagneticFlux<T>;
...
// 1/InverseMagneticFlux -> MagneticFlux
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
impl<T> core::ops::Div<InverseMagneticFlux<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = MagneticFlux<T>;
...
// 1/InverseMagneticFlux -> MagneticFlux
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
impl<T> core::ops::Div<InverseMagneticFlux<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = MagneticFlux<T>;
...
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseMagneticFlux<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = MagneticFlux<T>;
...
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMagneticFlux<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = MagneticFlux<T>;
...
/// Dividing a scalar value by a InverseMagneticFlux unit value returns a value of type MagneticFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMagneticFlux<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_m2_per_Wb(m2_per_Wb: T) -> Self {
        InverseMagneticFluxDensity {
            m2_per_Wb: m2_per_Wb,
        }
    }
    ...
    pub fn to_m2_per_Wb(&self) -> T {
        self.m2_per_Wb.clone()
    }
    ...
    pub fn from_square_meters_per_weber(square_meters_per_weber: T) -> Self {
        InverseMagneticFluxDensity {
            m2_per_Wb: square_meters_per_weber,
        }
    }

    /// Returns a copy of this inverse magnetic flux density value in square meters per weber
    pub fn to_square_meters_per_weber(&self) -> T {
        self.m2_per_Wb.clone()
    }
    ...
    pub fn from_per_T(per_T: T) -> Self {
        InverseMagneticFluxDensity { m2_per_Wb: per_T }
    }

    /// Returns a copy of this inverse magnetic flux density value in inverse teslas
    pub fn to_per_T(&self) -> T {
        self.m2_per_Wb.clone()
    }
    ...
    pub fn from_per_tesla(per_tesla: T) -> Self {
        InverseMagneticFluxDensity {
            m2_per_Wb: per_tesla,
        }
    }
    ...
    /// Returns a copy of this inverse magnetic flux density value in inverse teslas
    pub fn to_per_tesla(&self) -> T {
        self.m2_per_Wb.clone()
    }
}

impl<T> fmt::Display for InverseMagneticFluxDensity<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl core::ops::Mul<InverseMagneticFluxDensity<num_bigfloat::BigFloat>> for num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: InverseMagneticFluxDensity<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self * rhs.m2_per_Wb,
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
#[cfg(feature = "num-bigfloat")]
impl core::ops::Mul<InverseMagneticFluxDensity<num_bigfloat::BigFloat>>
    for &num_bigfloat::BigFloat
{
    type Output = InverseMagneticFluxDensity<num_bigfloat::BigFloat>;
    fn mul(self, rhs: InverseMagneticFluxDensity<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.clone() * rhs.m2_per_Wb,
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
    ...
    for num_bigfloat::BigFloat
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self * rhs.m2_per_Wb.clone(),
        }
    }
}
/// Multiplying a unit value by a scalar value returns a unit value
    ...
    for &num_bigfloat::BigFloat
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<num_bigfloat::BigFloat>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: self.clone() * rhs.m2_per_Wb.clone(),
        }
    }
}
...
/// Multiplying a unit value by a scalar value returns a unit value
#[cfg(feature = "num-complex")]
impl core::ops::Mul<InverseMagneticFluxDensity<num_complex::Complex32>>
    for &num_complex::Complex32
{
    type Output = InverseMagneticFluxDensity<num_complex::Complex32>;
    fn mul(self, rhs: InverseMagneticFluxDensity<num_complex::Complex32>) -> Self::Output {
        InverseMagneticFluxDensity {
...
/// Multiplying a unit value by a scalar value returns a unit value
#[cfg(feature = "num-complex")]
impl core::ops::Mul<InverseMagneticFluxDensity<num_complex::Complex64>>
    for &num_complex::Complex64
{
    type Output = InverseMagneticFluxDensity<num_complex::Complex64>;
    fn mul(self, rhs: InverseMagneticFluxDensity<num_complex::Complex64>) -> Self::Output {
        InverseMagneticFluxDensity {
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseMagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb.clone() / rhs.per_Wb,
        }
    }
}
/// Dividing a InverseMagneticFluxDensity by a InverseMagneticFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb / rhs.per_Wb.clone(),
        }
    }
}
/// Dividing a InverseMagneticFluxDensity by a InverseMagneticFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseMagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: MagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb.clone() * rhs.Wb,
        }
    }
}
/// Multiplying a InverseMagneticFluxDensity by a MagneticFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb * rhs.Wb.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFluxDensity by a MagneticFlux returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Area {
            m2: self.m2_per_Wb.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for InverseMagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: Area<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb.clone() / rhs.m2,
        }
    }
}
/// Dividing a InverseMagneticFluxDensity by a Area returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb / rhs.m2.clone(),
        }
    }
}
/// Dividing a InverseMagneticFluxDensity by a Area returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for InverseMagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb * rhs.per_m2,
        }
    }
}
/// Multiplying a InverseMagneticFluxDensity by a InverseArea returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseArea<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb.clone() * rhs.per_m2,
        }
    }
}
/// Multiplying a InverseMagneticFluxDensity by a InverseArea returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb * rhs.per_m2.clone(),
        }
    }
}
/// Multiplying a InverseMagneticFluxDensity by a InverseArea returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.m2_per_Wb.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for f64
where
    T: NumLike + From<f64>,
{
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFluxDensity {
            T: T::from(self.clone()) / rhs.m2_per_Wb,
        }
    }
}
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFluxDensity {
            T: T::from(self) / rhs.m2_per_Wb.clone(),
        }
    }
}
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        MagneticFluxDensity {
            T: T::from(self.clone()) / rhs.m2_per_Wb.clone(),
        }
    }
}
...
// 1/InverseMagneticFluxDensity -> MagneticFluxDensity
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = MagneticFluxDensity<T>;
...
// 1/InverseMagneticFluxDensity -> MagneticFluxDensity
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = MagneticFluxDensity<T>;
...
// 1/InverseMagneticFluxDensity -> MagneticFluxDensity
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = MagneticFluxDensity<T>;
...
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = MagneticFluxDensity<T>;
...
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = MagneticFluxDensity<T>;
...
/// Dividing a scalar value by a InverseMagneticFluxDensity unit value returns a value of type MagneticFluxDensity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseMagneticFluxDensity<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = MagneticFluxDensity<T>;
    ...
    T: NumLike,
{
    ...
    pub fn from_per_V(per_V: T) -> Self {
        InverseVoltage { per_V: per_V }
    }

    /// Returns a copy of this inverse voltage value in inverse volts
    pub fn to_per_V(&self) -> T {
        self.per_V.clone()
    }
    ...
    pub fn from_per_volt(per_volt: T) -> Self {
        InverseVoltage { per_V: per_volt }
    }

    /// Returns a copy of this inverse voltage value in inverse volts
    pub fn to_per_volt(&self) -> T {
        self.per_V.clone()
    }
}

impl<T> fmt::Display for InverseVoltage<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_per_mV(per_mV: T) -> Self {
        InverseVoltage {
            per_V: per_mV * T::from(1000.0_f64),
        }
    }
    ...
    pub fn from_per_uV(per_uV: T) -> Self {
        InverseVoltage {
            per_V: per_uV * T::from(1000000.0_f64),
        }
    }
    ...
    pub fn from_per_nV(per_nV: T) -> Self {
        InverseVoltage {
            per_V: per_nV * T::from(1000000000.0_f64),
        }
    }
...
impl core::ops::Mul<&InverseVoltage<num_bigfloat::BigFloat>> for &num_bigfloat::BigFloat {
    ...
    fn mul(self, rhs: &InverseVoltage<num_bigfloat::BigFloat>) -> Self::Output {
        InverseVoltage {
            per_V: self.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Current<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Current<T>) -> Self::Output {
        Conductance {
            S: self.per_V.clone() * rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Current<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Current<T>) -> Self::Output {
        InversePower {
            per_W: self.per_V.clone() / rhs.A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCurrent<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InversePower<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseCurrent<T>) -> Self::Output {
        InversePower {
            per_W: self.per_V.clone() * rhs.per_A,
        }
    }
}
/// Multiplying a InverseVoltage by a InverseCurrent returns a value of type InversePower
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InversePower {
            per_W: self.per_V * rhs.per_A.clone(),
        }
    }
}
/// Multiplying a InverseVoltage by a InverseCurrent returns a value of type InversePower
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        InversePower {
            per_W: self.per_V.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Conductance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Conductance {
            S: self.per_V.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_V.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Capacitance<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Capacitance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_V.clone() / rhs.F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Charge<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Charge<T>) -> Self::Output {
        Capacitance {
            F: self.per_V.clone() * rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Charge<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_V.clone() / rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Conductance<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Conductance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_V.clone() / rhs.S.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Elastance<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Elastance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_V.clone() * rhs.per_F,
        }
    }
}
/// Multiplying a InverseVoltage by a Elastance returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Elastance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_V * rhs.per_F.clone(),
        }
    }
}
/// Multiplying a InverseVoltage by a Elastance returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Elastance<T>) -> Self::Output {
        InverseCharge {
            per_C: self.per_V.clone() * rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCharge<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseEnergy<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseCharge<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_V.clone() * rhs.per_C,
        }
    }
}
/// Multiplying a InverseVoltage by a InverseCharge returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_V * rhs.per_C.clone(),
        }
    }
}
/// Multiplying a InverseVoltage by a InverseCharge returns a value of type InverseEnergy
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        InverseEnergy {
            per_J: self.per_V.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Capacitance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Capacitance {
            F: self.per_V.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseMagneticFlux<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Time {
            s: self.per_V.clone() / rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<MagneticFlux<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &MagneticFlux<T>) -> Self::Output {
        Time {
            s: self.per_V.clone() * rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Resistance<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Resistance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_V.clone() * rhs.Ohm,
        }
    }
}
/// Multiplying a InverseVoltage by a Resistance returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Resistance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_V * rhs.Ohm.clone(),
        }
    }
}
/// Multiplying a InverseVoltage by a Resistance returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Resistance<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.per_V.clone() * rhs.Ohm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Energy<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Energy<T>) -> Self::Output {
        Charge {
            C: self.per_V.clone() * rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Torque<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Torque<T>) -> Self::Output {
        Charge {
            C: self.per_V.clone() * rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: Frequency<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_V.clone() * rhs.Hz,
        }
    }
}
/// Multiplying a InverseVoltage by a Frequency returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_V * rhs.Hz.clone(),
        }
    }
}
/// Multiplying a InverseVoltage by a Frequency returns a value of type InverseMagneticFlux
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: self.per_V.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseEnergy<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseEnergy<T>) -> Self::Output {
        Charge {
            C: self.per_V.clone() / rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseTorque<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseTorque<T>) -> Self::Output {
        Charge {
            C: self.per_V.clone() / rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InversePower<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InversePower<T>) -> Self::Output {
        Current {
            A: self.per_V.clone() / rhs.per_W.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Power<T>> for InverseVoltage<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Power<T>) -> Self::Output {
        Current {
            A: self.per_V.clone() * rhs.W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseVoltage<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Voltage<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Voltage {
            V: T::from(self.clone()) / rhs.per_V.clone(),
        }
    }
}
...
// 1/InverseVoltage -> Voltage
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
impl<T> core::ops::Div<InverseVoltage<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Voltage<T>;
...
// 1/InverseVoltage -> Voltage
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
impl<T> core::ops::Div<InverseVoltage<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Voltage<T>;
...
// 1/InverseVoltage -> Voltage
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
impl<T> core::ops::Div<InverseVoltage<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Voltage<T>;
...
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<InverseVoltage<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Voltage<T>;
...
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseVoltage<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Voltage<T>;
...
/// Dividing a scalar value by a InverseVoltage unit value returns a value of type Voltage
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<InverseVoltage<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Voltage<T>;
...
impl<T> fmt::Display for LuminousFlux<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_Glm(Glm: T) -> Self {
        LuminousFlux {
            lm: Glm * T::from(1000000000.0_f64),
        }
    }
}
...
impl<T> core::ops::Mul<InverseLuminosity<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseLuminosity<T>) -> Self::Output {
        SolidAngle {
            sr: self.lm.clone() * rhs.per_cd.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Luminosity<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = SolidAngle<T>;
...
impl<T> core::ops::Mul<AreaPerLumen<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: AreaPerLumen<T>) -> Self::Output {
        Area {
            m2: self.lm.clone() * rhs.m2_per_lm,
        }
    }
}
/// Multiplying a LuminousFlux by a AreaPerLumen returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        Area {
            m2: self.lm * rhs.m2_per_lm.clone(),
        }
    }
}
/// Multiplying a LuminousFlux by a AreaPerLumen returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &AreaPerLumen<T>) -> Self::Output {
        Area {
            m2: self.lm.clone() * rhs.m2_per_lm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Illuminance<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Illuminance<T>) -> Self::Output {
        Area {
            m2: self.lm.clone() / rhs.lux.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Area<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = Illuminance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Area<T>) -> Self::Output {
        Illuminance {
            lux: self.lm.clone() / rhs.m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseArea<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = Illuminance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        Illuminance {
            lux: self.lm.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseSolidAngle<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseSolidAngle<T>) -> Self::Output {
        Luminosity {
            cd: self.lm.clone() * rhs.per_sr.clone(),
        }
    }
}
...
impl<T> core::ops::Div<SolidAngle<T>> for LuminousFlux<T>
where
    T: NumLike,
{
    type Output = Luminosity<T>;
...
impl<T> core::ops::Div<LuminousFlux<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseLuminousFlux<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: LuminousFlux<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: T::from(self.clone()) / rhs.lm,
        }
    }
}
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: T::from(self) / rhs.lm.clone(),
        }
    }
}
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &LuminousFlux<T>) -> Self::Output {
        InverseLuminousFlux {
            per_lm: T::from(self.clone()) / rhs.lm.clone(),
        }
    }
}
...
// 1/LuminousFlux -> InverseLuminousFlux
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
impl<T> core::ops::Div<LuminousFlux<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseLuminousFlux<T>;
...
// 1/LuminousFlux -> InverseLuminousFlux
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
impl<T> core::ops::Div<LuminousFlux<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseLuminousFlux<T>;
...
// 1/LuminousFlux -> InverseLuminousFlux
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
impl<T> core::ops::Div<LuminousFlux<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseLuminousFlux<T>;
...
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<LuminousFlux<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseLuminousFlux<T>;
...
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<LuminousFlux<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseLuminousFlux<T>;
...
/// Dividing a scalar value by a LuminousFlux unit value returns a value of type InverseLuminousFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<LuminousFlux<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseLuminousFlux<T>;
...
impl<T> fmt::Display for MagneticFlux<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_GWb(GWb: T) -> Self {
        MagneticFlux {
            Wb: GWb * T::from(1000000000.0_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::MagneticFlux> for MagneticFlux<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::MagneticFlux> for MagneticFlux<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::MagneticFlux> for MagneticFlux<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::MagneticFlux> for MagneticFlux<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Current<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<Current<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
...
impl<T> core::ops::Mul<InverseCurrent<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Inductance {
            H: self.Wb.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Energy {
            J: self.Wb.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Time<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
...
impl<T> core::ops::Div<Charge<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
...
impl<T> core::ops::Mul<Conductance<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Div<Inductance<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
...
impl<T> core::ops::Mul<InverseCharge<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        Resistance {
            Ohm: self.Wb.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseInductance<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Current<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseInductance<T>) -> Self::Output {
        Current {
            A: self.Wb.clone() * rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFluxDensity<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Area<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFluxDensity<T>) -> Self::Output {
        Area {
            m2: self.Wb.clone() * rhs.m2_per_Wb,
        }
    }
}
/// Multiplying a MagneticFlux by a InverseMagneticFluxDensity returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        Area {
            m2: self.Wb * rhs.m2_per_Wb.clone(),
        }
    }
}
/// Multiplying a MagneticFlux by a InverseMagneticFluxDensity returns a value of type Area
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFluxDensity<T>) -> Self::Output {
        Area {
            m2: self.Wb.clone() * rhs.m2_per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        Time {
            s: self.Wb.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFluxDensity<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Area<T>;
...
impl<T> core::ops::Div<Resistance<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Div<Voltage<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Div<Area<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = MagneticFluxDensity<T>;
...
impl<T> core::ops::Mul<InverseArea<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = MagneticFluxDensity<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseArea<T>) -> Self::Output {
        MagneticFluxDensity {
            T: self.Wb.clone() * rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Energy<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
...
impl<T> core::ops::Mul<InverseEnergy<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for MagneticFlux<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseTorque<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb.clone() * rhs.per_Nm,
        }
    }
}
/// Multiplying a MagneticFlux by a InverseTorque returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb * rhs.per_Nm.clone(),
        }
    }
}
/// Multiplying a MagneticFlux by a InverseTorque returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Wb.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseMagneticFlux<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: MagneticFlux<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: T::from(self.clone()) / rhs.Wb,
        }
    }
}
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: T::from(self) / rhs.Wb.clone(),
        }
    }
}
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseMagneticFlux {
            per_Wb: T::from(self.clone()) / rhs.Wb.clone(),
        }
    }
}
...
// 1/MagneticFlux -> InverseMagneticFlux
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
impl<T> core::ops::Div<MagneticFlux<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseMagneticFlux<T>;
...
// 1/MagneticFlux -> InverseMagneticFlux
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
impl<T> core::ops::Div<MagneticFlux<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseMagneticFlux<T>;
...
// 1/MagneticFlux -> InverseMagneticFlux
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
impl<T> core::ops::Div<MagneticFlux<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseMagneticFlux<T>;
...
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<MagneticFlux<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseMagneticFlux<T>;
...
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<MagneticFlux<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseMagneticFlux<T>;
...
/// Dividing a scalar value by a MagneticFlux unit value returns a value of type InverseMagneticFlux
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<MagneticFlux<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseMagneticFlux<T>;
...
impl<T> fmt::Display for MagneticFluxDensity<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::MagneticFluxDensity> for MagneticFluxDensity<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::MagneticFluxDensity {
        uom::si::f32::MagneticFluxDensity::new::<uom::si::magnetic_flux_density::tesla>(
            self.T.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::MagneticFluxDensity> for MagneticFluxDensity<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::MagneticFluxDensity> for MagneticFluxDensity<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::MagneticFluxDensity {
        uom::si::f64::MagneticFluxDensity::new::<uom::si::magnetic_flux_density::tesla>(
            self.T.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::MagneticFluxDensity> for MagneticFluxDensity<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for MagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.T.clone() * rhs.per_Wb,
        }
    }
}
/// Multiplying a MagneticFluxDensity by a InverseMagneticFlux returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.T * rhs.per_Wb.clone(),
        }
    }
}
/// Multiplying a MagneticFluxDensity by a InverseMagneticFlux returns a value of type InverseArea
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.T.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for MagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = InverseArea<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseArea {
            per_m2: self.T.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Area<T>> for MagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Div<InverseArea<T>> for MagneticFluxDensity<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseArea<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.T.clone() / rhs.per_m2.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFluxDensity<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseMagneticFluxDensity<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: T::from(self.clone()) / rhs.T,
        }
    }
}
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: T::from(self) / rhs.T.clone(),
        }
    }
}
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &MagneticFluxDensity<T>) -> Self::Output {
        InverseMagneticFluxDensity {
            m2_per_Wb: T::from(self.clone()) / rhs.T.clone(),
        }
    }
}
...
// 1/MagneticFluxDensity -> InverseMagneticFluxDensity
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
impl<T> core::ops::Div<MagneticFluxDensity<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
// 1/MagneticFluxDensity -> InverseMagneticFluxDensity
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
impl<T> core::ops::Div<MagneticFluxDensity<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
// 1/MagneticFluxDensity -> InverseMagneticFluxDensity
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
impl<T> core::ops::Div<MagneticFluxDensity<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<MagneticFluxDensity<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<MagneticFluxDensity<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
/// Dividing a scalar value by a MagneticFluxDensity unit value returns a value of type InverseMagneticFluxDensity
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<MagneticFluxDensity<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseMagneticFluxDensity<T>;
...
impl<T> fmt::Display for Resistance<T>
where
    T: NumLike,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
    ...
    T: NumLike + From<f64>,
{
    ...
    pub fn from_GOhm(GOhm: T) -> Self {
        Resistance {
            Ohm: GOhm * T::from(1000000000.0_f64),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ElectricalResistance> for Resistance<T>
where
    T: NumLike + Into<f32>,
{
    fn into(self) -> uom::si::f32::ElectricalResistance {
        uom::si::f32::ElectricalResistance::new::<uom::si::electrical_resistance::ohm>(
            self.Ohm.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ElectricalResistance> for Resistance<T>
where
    T: NumLike + From<f32>,
{
    fn from(src: uom::si::f32::ElectricalResistance) -> Self {
        Resistance {
            Ohm: T::from(src.value),
        }
    }
}
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ElectricalResistance> for Resistance<T>
where
    T: NumLike + Into<f64>,
{
    fn into(self) -> uom::si::f64::ElectricalResistance {
        uom::si::f64::ElectricalResistance::new::<uom::si::electrical_resistance::ohm>(
            self.Ohm.into(),
        )
    }
}
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ElectricalResistance> for Resistance<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Current<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
...
impl<T> core::ops::Div<InverseCurrent<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Voltage<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Voltage {
            V: self.Ohm.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
...
impl<T> core::ops::Div<Time<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Time<T>) -> Self::Output {
        Elastance {
            per_F: self.Ohm.clone() / rhs.s.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Capacitance<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
...
impl<T> core::ops::Mul<Charge<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Div<Elastance<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Time<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Elastance<T>) -> Self::Output {
        Time {
            s: self.Ohm.clone() / rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Inductance<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
...
impl<T> core::ops::Div<InverseCharge<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        MagneticFlux {
            Wb: self.Ohm.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseInductance<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseInductance<T>) -> Self::Output {
        Frequency {
            Hz: self.Ohm.clone() * rhs.per_H.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseMagneticFlux<T>) -> Self::Output {
        InverseCharge {
            per_C: self.Ohm.clone() * rhs.per_Wb,
        }
    }
}
/// Multiplying a Resistance by a InverseMagneticFlux returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseCharge {
            per_C: self.Ohm * rhs.per_Wb.clone(),
        }
    }
}
/// Multiplying a Resistance by a InverseMagneticFlux returns a value of type InverseCharge
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        InverseCharge {
            per_C: self.Ohm.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseVoltage<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: InverseVoltage<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Ohm.clone() * rhs.per_V,
        }
    }
}
/// Multiplying a Resistance by a InverseVoltage returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Ohm * rhs.per_V.clone(),
        }
    }
}
/// Multiplying a Resistance by a InverseVoltage returns a value of type InverseCurrent
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseVoltage<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Ohm.clone() * rhs.per_V.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &MagneticFlux<T>) -> Self::Output {
        InverseCharge {
            per_C: self.Ohm.clone() / rhs.Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Voltage<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Voltage<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.Ohm.clone() / rhs.V.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Frequency<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &Frequency<T>) -> Self::Output {
        Elastance {
            per_F: self.Ohm.clone() * rhs.Hz.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for Resistance<T>
where
    T: NumLike,
{
    type Output = Inductance<T>;
...
impl<T> core::ops::Div<Resistance<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = Conductance<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Resistance<T>) -> Self::Output {
        Conductance {
            S: T::from(self.clone()) / rhs.Ohm.clone(),
        }
    }
}
...
// 1/Resistance -> Conductance
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
impl<T> core::ops::Div<Resistance<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = Conductance<T>;
...
// 1/Resistance -> Conductance
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
impl<T> core::ops::Div<Resistance<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = Conductance<T>;
...
// 1/Resistance -> Conductance
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
impl<T> core::ops::Div<Resistance<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = Conductance<T>;
...
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Resistance<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = Conductance<T>;
...
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Resistance<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = Conductance<T>;
...
/// Dividing a scalar value by a Resistance unit value returns a value of type Conductance
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Resistance<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = Conductance<T>;
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f32::ElectricPotential> for Voltage<T>
where
    T: NumLike + Into<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f32::ElectricPotential> for Voltage<T>
where
    T: NumLike + From<f32>,
{
...
#[cfg(feature = "uom")]
impl<T> Into<uom::si::f64::ElectricPotential> for Voltage<T>
where
    T: NumLike + Into<f64>,
{
...
#[cfg(feature = "uom")]
impl<T> From<uom::si::f64::ElectricPotential> for Voltage<T>
where
    T: NumLike + From<f64>,
{
...
impl<T> core::ops::Mul<Current<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Power<T>;
...
impl<T> core::ops::Div<Current<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
...
impl<T> core::ops::Mul<InverseCurrent<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Resistance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Resistance {
            Ohm: self.V.clone() * rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCurrent<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Power<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCurrent<T>) -> Self::Output {
        Power {
            W: self.V.clone() / rhs.per_A.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Time<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Mul<Capacitance<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
...
impl<T> core::ops::Mul<Charge<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
...
impl<T> core::ops::Div<Charge<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Charge<T>) -> Self::Output {
        Elastance {
            per_F: self.V.clone() / rhs.C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<Conductance<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Current<T>;
...
impl<T> core::ops::Div<Elastance<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Charge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Elastance<T>) -> Self::Output {
        Charge {
            C: self.V.clone() / rhs.per_F.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseCharge<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Elastance<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseCharge<T>) -> Self::Output {
        Elastance {
            per_F: self.V.clone() * rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Div<InverseCharge<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Energy<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &InverseCharge<T>) -> Self::Output {
        Energy {
            J: self.V.clone() / rhs.per_C.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseMagneticFlux<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseMagneticFlux<T>) -> Self::Output {
        Frequency {
            Hz: self.V.clone() * rhs.per_Wb.clone(),
        }
    }
}
...
impl<T> core::ops::Div<MagneticFlux<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Frequency<T>;
...
impl<T> core::ops::Div<Resistance<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = Current<T>;
...
impl<T> core::ops::Div<Energy<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Energy<T>) -> Self::Output {
        InverseCharge {
            per_C: self.V.clone() / rhs.J.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Torque<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Torque<T>) -> Self::Output {
        InverseCharge {
            per_C: self.V.clone() / rhs.Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Frequency<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = MagneticFlux<T>;
...
impl<T> core::ops::Mul<InverseEnergy<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseEnergy<T>) -> Self::Output {
        InverseCharge {
            per_C: self.V.clone() * rhs.per_J.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InverseTorque<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCharge<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InverseTorque<T>) -> Self::Output {
        InverseCharge {
            per_C: self.V.clone() * rhs.per_Nm.clone(),
        }
    }
}
...
impl<T> core::ops::Mul<InversePower<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn mul(self, rhs: &InversePower<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.V.clone() * rhs.per_W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Power<T>> for Voltage<T>
where
    T: NumLike,
{
    type Output = InverseCurrent<T>;
    ...
    T: NumLike,
{
    ...
    fn div(self, rhs: &Power<T>) -> Self::Output {
        InverseCurrent {
            per_A: self.V.clone() / rhs.W.clone(),
        }
    }
}
...
impl<T> core::ops::Div<Voltage<T>> for f64
where
    T: NumLike + From<f64>,
{
    type Output = InverseVoltage<T>;
    ...
    T: NumLike + From<f64>,
{
    ...
    fn div(self, rhs: &Voltage<T>) -> Self::Output {
        InverseVoltage {
            per_V: T::from(self.clone()) / rhs.V.clone(),
        }
    }
}
...
// 1/Voltage -> InverseVoltage
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
impl<T> core::ops::Div<Voltage<T>> for f32
where
    T: NumLike + From<f32>,
{
    type Output = InverseVoltage<T>;
...
// 1/Voltage -> InverseVoltage
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
impl<T> core::ops::Div<Voltage<T>> for i64
where
    T: NumLike + From<i64>,
{
    type Output = InverseVoltage<T>;
...
// 1/Voltage -> InverseVoltage
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
impl<T> core::ops::Div<Voltage<T>> for i32
where
    T: NumLike + From<i32>,
{
    type Output = InverseVoltage<T>;
...
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
#[cfg(feature = "num-bigfloat")]
impl<T> core::ops::Div<Voltage<T>> for num_bigfloat::BigFloat
where
    T: NumLike + From<num_bigfloat::BigFloat>,
{
    type Output = InverseVoltage<T>;
...
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Voltage<T>> for num_complex::Complex32
where
    T: NumLike + From<num_complex::Complex32>,
{
    type Output = InverseVoltage<T>;
...
/// Dividing a scalar value by a Voltage unit value returns a value of type InverseVoltage
#[cfg(feature = "num-complex")]
impl<T> core::ops::Div<Voltage<T>> for num_complex::Complex64
where
    T: NumLike + From<num_complex::Complex64>,
{
    type Output = InverseVoltage<T>;
